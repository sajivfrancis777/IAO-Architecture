<div style="text-align:center; padding-top:20px;">
  ...
  <h1 style="font-size:36px; margin-top:24px;">Q-140 — Manage Product Disposition (IF)</h1>
...
<div class="page-footer"><span>Page 1</span><span><a href="#toc">↑ Back to TOC</a></span><span>Q-140 — Manage Product Disposition (IF)</span></div>
...
<div class="page-footer"><span>Page 2</span><span><a href="#toc">↑ Back to TOC</a></span><span>Q-140 — Manage Product Disposition (IF)</span></div>
<div style="page-break-before: always;"></div>


## 1. Executive Summary

This Architecture Document defines the **Business, Data, Application, and Technology** (BDAT) architecture for **Q-140 Manage Product Disposition (IF)** within the IAO program. It includes 1 BPMN process diagram(s) in Section 3.
...
<div class="page-footer"><span>Page 3</span><span><a href="#toc">↑ Back to TOC</a></span><span>Q-140 — Manage Product Disposition (IF)</span></div>
<div style="page-break-before: always;"></div>
...
| **L1 Process** | Q Quality Management (IF) |
| **L2 Capability** | Q-140 - Manage Product Disposition (IF) |
...
| 4 | Q-140 Process Migration | Migrate Manage Product Disposition (IF) business processes and 0 integrated systems from legacy to S/4 HANA target architecture | IDM 2.0 Supply Chain (Intel Foundry) | High |


<div class="page-footer"><span>Page 4</span><span><a href="#toc">↑ Back to TOC</a></span><span>Q-140 — Manage Product Disposition (IF)</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 5</span><span><a href="#toc">↑ Back to TOC</a></span><span>Q-140 — Manage Product Disposition (IF)</span></div>
<div style="page-break-before: always;"></div>
...
This capability includes **1 business process(es)** modeled in BPMN 2.0, covering the end-to-end workflow for Q-140 Manage Product Disposition (IF).

| # | Step ID | Process Name | Lanes | Tasks | Gateways |
|---|---------|--------------|-------|-------|----------|
| 1 | Q-140-210_Scrap_Material_(IF) | Q-140-210_Scrap_Material_(IF) | FTS IF - Batch User, IT Department, LOG - Inventory Planner | 8 | 4 |


<div class="page-footer"><span>Page 6</span><span><a href="#toc">↑ Back to TOC</a></span><span>Q-140 — Manage Product Disposition (IF)</span></div>
<div style="page-break-before: always;"></div>
...
#### BUSINESS ARCHITECTURE — 3.2.1 Q-140-210_Scrap_Material_(IF) — Q-140-210_Scrap_Material_(IF)

**Swim Lanes**: FTS IF - Batch User · IT Department · LOG - Inventory Planner | **Tasks**: 8 | **Gateways**: 4
...
flowchart LR
    ...
    subgraph lane_1["IT Department"]
        ...
        n5[["fa:fa-cog Determine SAP Production Order"]]
        n6[["fa:fa-cog Determine SAP Material, Batch, Plant, Storage Locations, Movement Type"]]
        n7[["fa:fa-cog Determine if Lot is Inventory or WIP"]]
        n9(["fa:fa-play Initiate Scrap material procedure"])
        n11{{"fa:fa-code-branch Lot Type ?"}}
    ...
    n11 -->|"Inventory"| n6
    n1 --> n12
    n12 -->|"Move Out Event"| n4
    n12 -->|"Take Loss Event"| n3
    class n1 userTask
...
<div class="page-footer"><span>Page 7</span><span><a href="#toc">↑ Back to TOC</a></span><span>Q-140 — Manage Product Disposition (IF)</span></div>
<div style="page-break-before: always;"></div>
...
|------------|-------------------|-------------|
| FTS IF - Batch User | Q-140-210_Scrap_Material_(IF) | |
| IT Department | Q-140-210_Scrap_Material_(IF) | |
| LOG - Inventory Planner | Q-140-210_Scrap_Material_(IF) | |


<div class="page-footer"><span>Page 8</span><span><a href="#toc">↑ Back to TOC</a></span><span>Q-140 — Manage Product Disposition (IF)</span></div>
<div style="page-break-before: always;"></div>
