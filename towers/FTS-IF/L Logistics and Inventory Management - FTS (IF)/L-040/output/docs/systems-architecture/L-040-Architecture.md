...
Standard RAID items for L-040 (Forecast to Stock (IF)):

| # | Category | Description | Status | Owner | Priority |
|---|----------|-------------|--------|-------|----------|
| 1 | Risk | Data migration completeness — validate all legacy Receive and Put-away Product - FTS (IF) data maps to S/4 target structures | Open | Tower Architect | High |
