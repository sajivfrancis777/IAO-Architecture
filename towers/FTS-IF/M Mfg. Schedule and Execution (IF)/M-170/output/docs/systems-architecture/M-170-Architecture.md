...
The following data flows are derived from the system integration hops for M-170. Each row shows source application on its database flowing to a target application on its database.
...
<div class="page-footer"><span>Page 17</span><span><a href="#toc">↑ Back to TOC</a></span><span>M-170 — Control and Report Production Operations (IF)</span></div>
<div style="page-break-before: always;"></div>
