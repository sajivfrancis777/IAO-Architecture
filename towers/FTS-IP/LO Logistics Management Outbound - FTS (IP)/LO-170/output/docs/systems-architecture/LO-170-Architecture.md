...
This Architecture Document defines the **Business, Data, Application, and Technology** (BDAT) architecture for **LO-170 Pack Orders - FTS (IP)** within the IAO program.
...
|------------|-------------------|-------------|
| Business Process Owner | LO-170 | Accountable for Pack Orders - FTS (IP) business process definition and sign-off |
