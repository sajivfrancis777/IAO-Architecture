...
|------------|-------------------|-------------|
| Business Process Owner | MDM-150 | Accountable for Maintain Product Related Data business process definition and sign-off |
| Functional Analyst | MDM-150 | Responsible for functional specification and test case design |
| Technical Developer | MDM-150 | Responsible for RICEFW build and unit testing |
| Integration Architect | MDM-150 | Designs and validates integration patterns and middleware flows |
...
The following data flows are derived from the system integration hops for MDM-150. Each row shows source application on its database flowing to a target application on its database.
...
Integration patterns identified from the system flow analysis for MDM-150:
...
Platform landscape inferred from integrated systems for MDM-150:
