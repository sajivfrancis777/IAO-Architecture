...
|------------|-------------------|-------------|
| Business Process Owner | MDM-020 | Accountable for Create and Maintain Vendors business process definition and sign-off |
| Functional Analyst | MDM-020 | Responsible for functional specification and test case design |
| Technical Developer | MDM-020 | Responsible for RICEFW build and unit testing |
| Integration Architect | MDM-020 | Designs and validates integration patterns and middleware flows |
...
The following data flows are derived from the system integration hops for MDM-020. Each row shows source application on its database flowing to a target application on its database.
...
| DATI1727 | Interface | Automated update to DC Sales Status and other Item Sales Data fields​ | 06. Dev In Progress |  | NA | 03.Medium |
...
Integration patterns identified from the system flow analysis for MDM-020:
...
Platform landscape inferred from integrated systems for MDM-020:
...
Standard RAID items for MDM-020 (Master Data):

| # | Category | Description | Status | Owner | Priority |
|---|----------|-------------|--------|-------|----------|
| 1 | Risk | Data migration completeness — validate all legacy Create and Maintain Vendors data maps to S/4 target structures | Open | Tower Architect | High |
