...
The following data flows are derived from the system integration hops for MDM-130. Each row shows source application on its database flowing to a target application on its database.
