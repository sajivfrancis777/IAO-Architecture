...
The following data flows are derived from the system integration hops for CM-050. Each row shows source application on its database flowing to a target application on its database.
...
<div class="page-footer"><span>Page 18</span><span><a href="#toc">↑ Back to TOC</a></span><span>CM-050 — Manage Customer Credit Exposure (IP)</span></div>
<div style="page-break-before: always;"></div>


### 7.2 RAID Log

Standard RAID items for CM-050 (Order To Cash (IP)):

| # | Category | Description | Status | Owner | Priority |
|---|----------|-------------|--------|-------|----------|
| 1 | Risk | Data migration completeness — validate all legacy Manage Customer Credit Exposure (IP) data maps to S/4 target structures | Open | Tower Architect | High |
