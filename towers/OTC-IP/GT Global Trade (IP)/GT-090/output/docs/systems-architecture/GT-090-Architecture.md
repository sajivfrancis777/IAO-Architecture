...
<div class="page-footer"><span>Page 16</span><span><a href="#toc">↑ Back to TOC</a></span><span>GT-090 — Customs Declaration Communication - Broker Filing (IP)</span></div>
</div>
<div style="page-break-before: always;"></div>
<div class="page-section">
...
Standard RAID items for GT-090 (Order To Cash (IP)):

| # | Category | Description | Status | Owner | Priority |
|---|----------|-------------|--------|-------|----------|
| 1 | Risk | Data migration completeness — validate all legacy Customs Declaration Communication - Broker Filing (IP) data maps to S/4 target structures | Open | Tower Architect | High |
