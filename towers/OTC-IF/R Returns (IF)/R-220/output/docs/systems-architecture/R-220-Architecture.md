...
|-----------|------|-------------|--------|--------|--------|-----------|
| R-220-R001 | Report | Manage In-bound Transportation (IF) operational report | Planned | SAP S/4HANA | Analytics | Medium |
| R-220-C001 | Conversion | Legacy data migration for Manage In-bound Transportation (IF) | Planned | Legacy ERP | SAP S/4HANA | High |
...
<div class="page-footer"><span>Page 14</span><span><a href="#toc">↑ Back to TOC</a></span><span>R-220 — Manage In-bound Transportation (IF)</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 15</span><span><a href="#toc">↑ Back to TOC</a></span><span>R-220 — Manage In-bound Transportation (IF)</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 16</span><span><a href="#toc">↑ Back to TOC</a></span><span>R-220 — Manage In-bound Transportation (IF)</span></div>
<div style="page-break-before: always;"></div>


### 7.2 RAID Log

Standard RAID items for R-220 (Order To Cash (IF)):

| # | Category | Description | Status | Owner | Priority |
|---|----------|-------------|--------|-------|----------|
| 1 | Risk | Data migration completeness — validate all legacy Manage In-bound Transportation (IF) data maps to S/4 target structures | Open | Tower Architect | High |
