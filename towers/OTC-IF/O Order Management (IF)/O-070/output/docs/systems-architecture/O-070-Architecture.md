...
|------------|-------------------|-------------|
| Business Process Owner | O-070 | Accountable for Manage Backorders (IF) business process definition and sign-off |
| Functional Analyst | O-070 | Responsible for functional specification and test case design |
| Technical Developer | O-070 | Responsible for RICEFW build and unit testing |
| Integration Architect | O-070 | Designs and validates integration patterns and middleware flows |
...
|-----------|------|-------------|--------|--------|--------|-----------|
| O-070-R001 | Report | Manage Backorders (IF) operational report | Planned | SAP S/4HANA | Analytics | Medium |
| O-070-C001 | Conversion | Legacy data migration for Manage Backorders (IF) | Planned | Legacy ERP | SAP S/4HANA | High |
...
<div class="page-footer"><span>Page 11</span><span><a href="#toc">↑ Back to TOC</a></span><span>O-070 — Manage Backorders (IF)</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 12</span><span><a href="#toc">↑ Back to TOC</a></span><span>O-070 — Manage Backorders (IF)</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 13</span><span><a href="#toc">↑ Back to TOC</a></span><span>O-070 — Manage Backorders (IF)</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 14</span><span><a href="#toc">↑ Back to TOC</a></span><span>O-070 — Manage Backorders (IF)</span></div>
<div style="page-break-before: always;"></div>


### 7.2 RAID Log

Standard RAID items for O-070 (Order To Cash (IF)):

| # | Category | Description | Status | Owner | Priority |
|---|----------|-------------|--------|-------|----------|
| 1 | Risk | Data migration completeness — validate all legacy Manage Backorders (IF) data maps to S/4 target structures | Open | Tower Architect | High |
...
---
*O-070 — Architecture Document (TOGAF BDAT) · Order To Cash (IF) · Generated: March 2026*

<div class="page-footer"><span>Page 15</span><span><a href="#toc">↑ Back to TOC</a></span><span>O-070 — Manage Backorders (IF)</span></div>
