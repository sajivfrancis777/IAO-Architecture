<div style="text-align:center; padding-top:20px;">
  ...
  Capability GT-030 · GT Global Trade (IF)</p>
...
flowchart TD
    ...
    subgraph lane_0["Trade Execution Analyst"]
        ...
        n7(["fa:fa-stop Business Partners Screening SPL Completed"])
        n8["Analyze / Determine reason for block or hold"]
        n9["Maintain Compliance Master Data"]
        n10["Maintain/Interface Customer/Vendor/Banks MD"]
        n11{{"fa:fa-code-branch Type of Screening?"}}
        n12{{"fa:fa-code-branch exclusiveGateway"}}
        n13{{"fa:fa-code-branch Partners Blocked?"}}
        n14{{"fa:fa-code-branch Way of Managing Block Partners?"}}
    ...
    n13 -->|"Yes"| n1
    n15 --> n7
    n11 -->|"Change BPs Address"| n5
    n11 -->|"Initial Screening"| n4
    n14 -->|"No Addition to List"| n8
    n14 -->|"In Negative List"| n3
    n14 -->|"In Positive List"| n2
    n9 --> n16
    n10 --> n16
    n16 --> n11
    n3 --> n15
...
flowchart TD
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["Trade Execution Analyst"]
        n1["fa:fa-user Manage Blocked Documents"]
        n2["fa:fa-user Display Technically Incomplete Customs Documents"]
        n3["fa:fa-user Display Documents (Compliance Management)"]
        n4(["fa:fa-stop Block in Transactions Checked"])
        n5["Analyze / Determine reason for block or hold"]
        n6["Notify responsible process owner to proceed with transaction or cancel the order"]
        n7["Create Sales Orders ( IF)"]
        n8["Change Order (IF)"]
        n9["Create Outbound Delivery (IF)"]
        n10["Create Inbound delivery (IF)"]
        n11["Create Purchase Orders (IF)"]
        n12["Create Sales Order ( IP)"]
        n13["Change Order (IP)"]
        n14["Change Purchase Orders (IF)"]
        n15["Create Outbound Delivery (IP)"]
        n16["Obtain and Record Shipping Notification (IF)"]
        n17["Obtain and Record Shipping Notification (IP)"]
        n18["Create Inbound delivery (IP)"]
        n19["Change Purchase Orders (IP)"]
        n20["Create Purchase Orders (IP)"]
        n21{{"fa:fa-code-branch Type of Block ?"}}
        n22{{"fa:fa-code-branch exclusiveGateway"}}
        n23{{"fa:fa-code-branch exclusiveGateway"}}
        n24{{"fa:fa-code-branch Document Blocked ?"}}
    ...
    n11 --> n23
    n10 --> n23
    n21 -->|"Technically Incomplete Block"| n2
    n23 --> n24
    n24 -->|"Yes"| n21
    n24 -->|"No"| n3
    n12 --> n23
...
flowchart TD
    ...
    subgraph lane_0["Trade Execution Analyst"]
        ...
        n6(["fa:fa-stop SPL Block User Decision Complete"])
        n7(["fa:fa-stop Compliance Screening Completed"])
        n8["Analyze / Determine reason for block or hold"]
        n9["Analyze / Determine reason for block or hold"]
        n10{{"fa:fa-code-branch exclusiveGateway"}}
        n11{{"fa:fa-code-branch Way of Managing Blocked Partners?"}}
        n12{{"fa:fa-code-branch Type of Data?"}}
        n13{{"fa:fa-code-branch Any Other Compliance Blocks?"}}
        n14{{"fa:fa-code-branch exclusiveGateway"}}
        n15{{"fa:fa-code-branch Release Documents ?"}}
    end
    n9 --> n12
    n4 --> n10
    n2 --> n10
    n1 --> n10
    n11 -->|"Negative List"| n4
    n13 -->|"Yes"| n8
    n11 -->|"Positive List"| n2
    n10 --> n6
    n12 --> n15
    n15 -->|"No"| n5
    n3 --> n14
    n14 --> n13
    n5 --> n14
    n12 -->|"Master Data (MD)"| n11
    n11 -->|"Releasing/Confirming Block"| n1
    n15 -->|"Yes"| n3
    n13 -->|"No"| n7
    class n1 userTask
    class n2 userTask
...
flowchart TD
    ...
    subgraph lane_0["Trade Execution Analyst"]
        ...
        n2["Recheck Blocked Documents"]
        n3["Analyze / Determine reason for block or hold"]
        n4["Analyze/Determine Reason for Block / Hold."]
        n5{{"fa:fa-code-branch Any Other Compliance Blocks Exist ?"}}
    end
    n4 --> n1
    n1 --> n5
    n5 -->|"No"| n2
...
flowchart TD
    ...
    subgraph lane_0["Trade Execution Analyst"]
        ...
        n3["Recheck Blocked Documents"]
        n4["Analyze / Determine reason for block or hold"]
...
flowchart TD
    ...
    subgraph lane_0["Trade Execution Analyst"]
        ...
        n3["Recheck Documents in Background (batch jobs)"]
        n4(["fa:fa-stop Documents Released"])
        n5["Check if block exists (transactions)"]
        n6["Notify responsible process owner to proceed with transaction or cancel the order"]
        n7["Check if block exists (transactions)"]
        n8["Analyze / Determine reason for block or hold"]
        n9["Business decision on SPL analysis result + take action"]
        n10["Business decision on Embargo analysis result + take action"]
        n11["Business decision on License control analysis result + take action"]
        n12{{"fa:fa-code-branch Mode of Checking Documents?"}}
        n13{{"fa:fa-code-branch Document Blocked?"}}
        n14{{"fa:fa-code-branch exclusiveGateway"}}
