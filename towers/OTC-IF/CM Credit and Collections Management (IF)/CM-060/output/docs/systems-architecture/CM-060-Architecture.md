...
|------------|-------------------|-------------|
| Business Process Owner | CM-060 | Accountable for Manage Collections (IF) business process definition and sign-off |
| Functional Analyst | CM-060 | Responsible for functional specification and test case design |
| Technical Developer | CM-060 | Responsible for RICEFW build and unit testing |
| Integration Architect | CM-060 | Designs and validates integration patterns and middleware flows |
...
|-----------|------|-------------|--------|--------|--------|-----------|
| CM-060-R001 | Report | Manage Collections (IF) operational report | Planned | SAP S/4HANA | Analytics | Medium |
| CM-060-C001 | Conversion | Legacy data migration for Manage Collections (IF) | Planned | Legacy ERP | SAP S/4HANA | High |
...
Standard RAID items for CM-060 (Order To Cash (IF)):

| # | Category | Description | Status | Owner | Priority |
|---|----------|-------------|--------|-------|----------|
| 1 | Risk | Data migration completeness — validate all legacy Manage Collections (IF) data maps to S/4 target structures | Open | Tower Architect | High |
...
---
*CM-060 — Architecture Document (TOGAF BDAT) · Order To Cash (IF) · Generated: March 2026*
