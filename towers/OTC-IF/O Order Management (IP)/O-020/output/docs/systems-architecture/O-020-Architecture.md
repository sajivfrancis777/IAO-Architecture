...
This Architecture Document defines the **Business, Data, Application, and Technology** (BDAT) architecture for **O-020 Capture Orders (IF)** within the IAO program.
| Dimension | Value |
|-----------|-------|
...
|------------|-------------------|-------------|
| Business Process Owner | O-020 | Accountable for Capture Orders (IF) business process definition and sign-off |
| Functional Analyst | O-020 | Responsible for functional specification and test case design |
| Technical Developer | O-020 | Responsible for RICEFW build and unit testing |
| Integration Architect | O-020 | Designs and validates integration patterns and middleware flows |
