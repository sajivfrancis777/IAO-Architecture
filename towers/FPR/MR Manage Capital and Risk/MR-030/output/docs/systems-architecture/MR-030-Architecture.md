<div style="text-align:center; padding-top:20px;">
  ...
  <h1 style="font-size:36px; margin-top:24px;">MR-030 — Manage Financial Risk</h1>
  <h2 style="font-size:24px;">Architecture Document (TOGAF BDAT)</h2>
  <p style="font-size:18px; color:#555;">Finance Plan To Report (FPR) Tower<br/>
  Capability MR-030 · MR Manage Capital and Risk</p>
...
<div class="page-footer"><span>Page 1</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
...
<div class="page-footer"><span>Page 2</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>


## 1. Executive Summary

This Architecture Document defines the **Business, Data, Application, and Technology** (BDAT) architecture for **MR-030 Manage Financial Risk** within the IAO program. It includes 2 BPMN process diagram(s) in Section 3.

| Dimension | Value |
|-----------|-------|
| **Tower** | Finance Plan To Report (FPR) |
| **Process Group** | MR Manage Capital and Risk |
| **Capability** | MR-030 - Manage Financial Risk |
| **Release** | R1 – R5 |
| **Total Systems** | 0 |
...
<div class="page-footer"><span>Page 3</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
| **L2 Capability** | MR-030 - Manage Financial Risk |
...
| 4 | MR-030 Process Migration | Migrate MR-030 business processes and 0 integrated systems from legacy to S/4 HANA target architecture | IDM 2.0 Finance | High |


<div class="page-footer"><span>Page 4</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
| MR-030 Migration Completeness | 100% flow chains validated | All 0 flow chains verified in target state | 0% (pre-migration) | Tower Architect |
...
<div class="page-footer"><span>Page 5</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
This capability includes **2 business process(es)** modeled in BPMN 2.0, covering the end-to-end workflow for MR-030 Manage Financial Risk.

| # | Step ID | Process Name | Lanes | Tasks | Gateways |
|---|---------|--------------|-------|-------|----------|
| 1 | MR-030-020_Identify_Financial_Risks | MR-030-020_Identify_Financial_Risks | Batch User | 8 | 2 |
| 2 | MR-030-090_Manage_Foreign_Exchange_Exposure | MR-030-090_Manage_Foreign_Exchange_Exposure | Batch User | 4 | 2 |


<div class="page-footer"><span>Page 6</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
#### BUSINESS ARCHITECTURE — 3.2.1 MR-030-020_Identify_Financial_Risks — MR-030-020_Identify_Financial_Risks

**Swim Lanes**: Batch User | **Tasks**: 8 | **Gateways**: 2
...
flowchart TD
    ...
    subgraph lane_0["Batch User"]
        n1["fa:fa-user Execute Risk and Insurance Management Processes"]
        n2[["fa:fa-cog Send Data from WCDS - Worker Snapshot Detail API"]]
        n3[["fa:fa-cog Send Data from SAP MDG - Location API"]]
        n4[["fa:fa-cog Send Data from Workday - New US Employee Payroll Report (RaaS)"]]
        n5[["fa:fa-cog Send Data from ECA Consumption View - New Property (Asset) Value Consumption..."]]
        n6[["fa:fa-cog Send Data from ECA Consumption View - New GLAA"]]
        n7[["fa:fa-cog Transform Data and Send to Origami"]]
        n8[["fa:fa-cog Create Risk Management Reports"]]
        n9(["fa:fa-play Identify Financial Risks Process Initiated"])
        n10(["fa:fa-stop Identify Financial Risks Process Completed"])
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqllmtvszYUx7-KRVWllUgFBELKi0mUhKpSu1VNLy-eTJMDJrFqbGQ7TbIo332HALmwJ5228SLKuf3-xwdj2BiJSIkRGJeXG8qpDtCmo-ckJ50AdaZYkY6JKsc7lhRPGVGdMicTXI_pn7s02y1WZVrpi3FO2br0jslMEPT2YKIQCpmJFOaqq4ikWcfsFJLmWK4jwYQssy_IILOynVoduhMyJfKQYFm--YrVZ6016sVOPNxr2V7fi6y_85plDl0_tNtzIvKLJuQIGsdxb3QY1ajv2dZ56F3c61tRCzrDmizx-gC8jdw9MPb82PbPAiu9dpeL6bMUSQPsjbzY2wP9OzsOnbNAN7TdQd0hcGYSF3PEMCd_WD8mxh3WyRy9wRgmxu9VUnlxG2IZDjLcLWeORiuSLDRBLxTmhHmKHrhawLZMCHrCHM_gAeYalT0SpYg6ZTk_9rBEzNAY9gsaYo1RJkWOPqLhGHXRh5CfIDTmuFBzodGQaEwZCp8fAHZM631LG4fP6Gl4D8BHkWBNBf8Jwv2-IegkhbvXRb-SJXobo1FeMLEmBD3jtRSMoRdSCHjorl4wHl-32N637FEUokjA7PJi19s7BYlKCIZXEKnX6CqEEepr9I7Zghxn39zctMT6_1Xs_jEMWyz_lPUKd1dlQuYVsLznO7wW6DdJZ3AOt-oHp_WRJLjZMEdbpBqdatXeXu1rCwajf0ghl2ZrFFMOmwzO9x1INTsMth_VFPgpgK6Pt611ICktin8mRQLuLvkJyd5sGhKWUixVFzONCiwxY4TdV4_4xNhuj4ucf1cEA63-8FvU7f5Sqta2bVcOp2X3Wrbbsr2W3a9tr-bveU7l8GvbacV7Ldtt2f2W7Vf2oDYHdbhRq83jc630Nuf5ids5PpRPIr2zEfdsxDsb6Z-N-Gcjg7OR2_0r93SNVv16PPXazTvi1O00bsM0ciJzTFMj2Bi7DyT4iEpJhhdMG1vTwAstxmueGMHuQ8JYFClUDimG8z2vnNu_AA5h-3g=" title="View full diagram">&#128065; View Diagram</a></div>



#### BUSINESS ARCHITECTURE — 3.2.2 MR-030-090_Manage_Foreign_Exchange_Exposure — MR-030-090_Manage_Foreign_Exchange_Exposure

**Swim Lanes**: Batch User | **Tasks**: 4 | **Gateways**: 2
...
flowchart TD
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["Batch User"]
        n1["fa:fa-user Execute Hedging Transactions"]
        n2[["fa:fa-cog Send Data from SAP GL"]]
        n3[["fa:fa-cog Send Data from Quantum"]]
        n4[["fa:fa-cog Calculate Exposure and Amount to Hedge"]]
        n5(["fa:fa-play Foreign Exchange Exposure Initiated"])
        n6(["fa:fa-stop Foreign Exchange Exposure Completed"])
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqlVV2L2zgU_SvCw5AuOODP2PVDIXHibqGFlkzbh2ZZbmQ5ESNLRpInSUP-e-XY-XCGDCzrB5NzdM-5Vze68t7CIidWYj0-7imnOkH7gV6TkgwSNFiCIgMbtcQPkBSWjKhBE1MIruf09zHMDaptE9ZwGZSU7Rp2TlaCoO-fbDQ2QmYjBVwNFZG0GNiDStIS5C4VTMgm-oHEhVMcs3VLEyFzIi8BjhO5ODRSRjm50H4UREHW6BTBguc90yIs4gIPDk1xTGzwGqQ-ll8r8gW2P2mu1wYXwBQxMWtdss-wJKzZo5Z1w-FavpyaQVWTh5uGzSvAlK8MHziGksCfL1ToHA7o8Pi44Oek6Gm64Mg8mIFSU1IgpQ09e9GooIwlD0E6zkLHVlqKZ5I8eLNo6ns2bnaSmK07dtPc4YbQ1VonS8HyLnS4afaQeNXWltvEc2y5M--bXITnl0zpyIu9-JxpErmpm54yFUXxvzKZvsonUM9drpmfedn0nMsNR2HqvPY7bXMaRGP3tk9EvlBMrkyzLPNnl1bNRqHr3DedZP7ISW9MV6DJBnYXw_dpcDbMwihzo7uGbb7bKuvlVynwydCfhVl4Nowmbjb27hoGYzeIuwqNz0pCtUYMOPnX-bWwJqDxGn03bVhY_7RBzcNds1ZAUsCw6TmabQmuNUF_k3xlTiF6MkdSAdZUcNUXer_OSixWaG4OB5qCBlRIUaL5-Cv6-NkoriX-m5JvNXBdlzeaoK9JgeGambabSiuhakkQGJdxKWqukRbHwsmNR_ju7FEx83dlQppjyY2FGSq-uvL6ZK4uatxz4_DXlcPo4qC0qN5wSEVZMfLaIdrvTw4gpdioITCNKpDAGGEf24O0sA6HK0383zSmne0PHqLh8IPJ2cGohV4f-h30Wxh30OvDuIVBB4MWdtPF3RaOro5xQ57Gt0d71zPYW_HvrgR3V8LzzdejR90l1SOj06D22PjEWrZVElkCza1kbx0_UuZDlpMCaqatg21BrcV8x7GVHC9zq65yo5xSMDNWtuThDyskOok=" title="View full diagram">&#128065; View Diagram</a></div>




<div class="page-footer"><span>Page 7</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
|------------|-------------------|-------------|
| Batch User | MR-030-020_Identify_Financial_Risks, MR-030-090_Manage_Foreign_Exchange_Exposure | |


<div class="page-footer"><span>Page 8</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 9</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 10</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 12</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 13</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 14</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 15</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 16</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
<div style="page-break-before: always;"></div>
...
---
*MR-030 — Architecture Document (TOGAF BDAT) · Finance Plan To Report · Generated: April 2026*

<div class="page-footer"><span>Page 17</span><span><a href="#toc">↑ Back to TOC</a></span><span>MR-030 — Manage Financial Risk</span></div>
