...
|------------|-------------------|-------------|
| Business Process Owner | MR-070 | Accountable for In-House Banking business process definition and sign-off |
| Functional Analyst | MR-070 | Responsible for functional specification and test case design |
| Technical Developer | MR-070 | Responsible for RICEFW build and unit testing |
| Integration Architect | MR-070 | Designs and validates integration patterns and middleware flows |
...
The following data entities are derived from the system integration flows for MR-070. Tower architects should validate ownership and classification.
...
The Current-State architecture represents the **current / legacy** landscape for MR-070.
...
The Future-State architecture represents the **target** landscape for MR-070.
...
Integration patterns identified from the system flow analysis for MR-070:
...
Platform landscape inferred from integrated systems for MR-070:
...
Standard RAID items for MR-070 (Finance Plan To Report):

| # | Category | Description | Status | Owner | Priority |
|---|----------|-------------|--------|-------|----------|
| 1 | Risk | Data migration completeness — validate all legacy In-House Banking data maps to S/4 target structures | Open | Tower Architect | High |
...
---
*MR-070 — Architecture Document (TOGAF BDAT) · Finance Plan To Report · Generated: March 2026*
