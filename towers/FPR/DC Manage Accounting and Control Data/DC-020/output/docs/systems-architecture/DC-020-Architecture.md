...
flowchart LR
    ...
    subgraph Cash L2 Approver
        n2["Receive Email Notification to Add GL Cash Account"]
    end
    subgraph Cash Representative
    ...
    subgraph Treasury Operations Manager
...
flowchart LR
    ...
    subgraph BPM L1 Governance Approver
