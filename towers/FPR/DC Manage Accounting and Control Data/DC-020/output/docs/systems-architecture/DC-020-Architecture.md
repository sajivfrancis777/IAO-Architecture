...
flowchart TD
    ...
    subgraph lane_0["MDG-F Requestor"]
        n1["fa:fa-user Create Change Request for Create/Update Chart of Accounts"]
        n2[["fa:fa-cog Process and Activate Chart of Accounts"]]
        n3[["fa:fa-cog Update Chart of Accounts in the System"]]
        n4(["fa:fa-play Creation of Chart of Accounts Requested (by Business)"])
        n5(["fa:fa-stop Maintenance of Chart of Accounts Completed"])
    end
    n2 --> n3
    n4 --> n1
    n3 --> n5
...
flowchart LR
    ...
    classDef gateway fill:#FFF9C4,stroke:#F57F17,stroke-width:2px,color:#E65100
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["ARC Chair Approver"]
        n1["Send Email to Requestor Including the Minutes and Decision Taken for Each GL..."]
        n8["Review the GL Non-Cash Account Creation"]
        n26{{"fa:fa-code-branch Approved?"}}
    end
    subgraph lane_1["Cash L2 Approver"]
        n2["Receive Email Notification to Add GL Cash Account"]
    end
    subgraph lane_2["Cash Representative"]
        n18["Populate Change Request Template Listing Details for the GL Cash Account to..."]
        n19["Submit Request to MDG to Create Master Data for GL Accounts"]
        n22(["fa:fa-stop Request for Master Data Maintenance Completed"])
        n27{{"fa:fa-code-branch exclusiveGateway"}}
    end
    subgraph lane_3["Preparer"]
        n9["Determine Whether to Create/Update Cost Center/Cost Center Group with..."]
        n10["Create Cost Center/Cost Center Group with Hierarchy Assignment Request..."]
        n11["Submit the Template to Preparer through Share Point Tool"]
        n12["Submit Request to MDG to Create Master Data for Cost Center"]
        n13["Determine Whether to Create/Update Profit Center/Profit Center Group with..."]
        n14["Create Profit Center/Profit Center Group with Hierarchy Assignment Request..."]
        n15["Submit the Template to Preparer Through Share Point Tool"]
        n16["Submit Request to MDG to Create Master Data for Profit Center"]
    end
    subgraph lane_4["Requestor"]
        n3["Create GL Account Request Template in PowerPoint"]
        n4["Submit the Template to ARC Chair"]
        n5["Present the GL Account Creation in Monthly ARC for Discussion/Review"]
        n6["Determine Whether to Edit and Resubmit or Withdraw the Request"]
        n7["Determine if Cash or Non- Cash Account"]
        n20(["fa:fa-play Request for Master Data Maintenance Initated"])
        n21(["fa:fa-stop Request Withdrawn"])
        n23{{"fa:fa-code-branch Decision made?"}}
        n24{{"fa:fa-code-branch exclusiveGateway"}}
        n25{{"fa:fa-code-branch Type of Account?"}}
        n28{{"fa:fa-arrows-alt parallelGateway"}}
    end
    subgraph lane_5["Treasury Operations Manager"]
        n17["Indicate What, Why and When Bank Account Cash GL will be Created using..."]
    end
    n3 --> n4
    n4 --> n5
    n6 --> n23
...
flowchart LR
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["ARC Chair Approver"]
        n8["fa:fa-user Review the GL Cash Account Request"]
        n11["Send Email to Requestor Including the Minutes and Decision Taken for Each GL..."]
        n20["Review the GL Non-Cash Account Creation"]
        n37{{"fa:fa-code-branch Approved?"}}
        n38{{"fa:fa-code-branch Request Approved?"}}
    end
    subgraph lane_1["BPM L1 Governance Approver"]
        n7["fa:fa-user Review the GL Non-Cash Account Request"]
        n10[["fa:fa-cog Create GL Non-Cash/ Cash Account in the System"]]
        n25(["fa:fa-stop GL Account Creation Process Completed"])
        n35{{"fa:fa-code-branch Request Approved?"}}
        n36{{"fa:fa-code-branch exclusiveGateway"}}
    end
    subgraph lane_2["Cash L2 Approver"]
        n1["fa:fa-user Review the GL Cash Account Request"]
        n12["Receive Email Notification to Add GL Cash Account"]
        n26{{"fa:fa-code-branch Request Approved ?"}}
    end
    subgraph lane_3["Cash Representative"]
        n5["fa:fa-user Submit the GL Cash Account Request"]
        n6["fa:fa-user Determine Whether to Re-Submit or Withdraw the Request"]
        n9[["fa:fa-cog Route the GL Cash Account Request to Pre-defined Approvers (Based on the..."]]
        n19["Populate Change Request Template Listing Details for the GL Cash Account to..."]
        n24(["fa:fa-stop Request Withdrawn"])
        n32{{"fa:fa-code-branch exclusiveGateway"}}
        n33{{"fa:fa-code-branch Decision?"}}
        n34{{"fa:fa-code-branch exclusiveGateway"}}
    end
    subgraph lane_4["GateKeeper"]
        n2["fa:fa-user Submit the GL Non-Cash Account Request"]
        n3["fa:fa-user Determine Whether to Re-Submit or Withdraw the Request"]
        n4["fa:fa-user Route the GL Non-Cash Request to Pre-Defined Approvers (Based on the..."]
        n23(["fa:fa-stop Request Withdrawn"])
        n30{{"fa:fa-code-branch exclusiveGateway"}}
        n31{{"fa:fa-code-branch Decision?"}}
    end
    subgraph lane_5["Requestor"]
        n13["Create GL Account Request Template in PowerPoint"]
        n14["Submit the Template to ARC Chair"]
        n15["Determine Whether to Edit and Resubmit or Withdraw the Request"]
        n16["Present the GL Account Creation in Monthly ARC for Discussion/Review"]
        n17["Determine if Cash or Non- Cash Account"]
        n21(["fa:fa-play GL Account Creation Requested"])
        n22(["fa:fa-stop Request Withdrawn"])
        n27{{"fa:fa-code-branch Decision made?"}}
        n28{{"fa:fa-code-branch Type of Account?"}}
        n29{{"fa:fa-code-branch exclusiveGateway"}}
    end
    subgraph lane_6["Treasury Operations Manager"]
        n18["Indicate What, Why and When Bank Account Cash GL will be Created using..."]
    end
    n21 --> n17
    n17 --> n28
    n13 --> n14
...
flowchart TD
    ...
    classDef gateway fill:#FFF9C4,stroke:#F57F17,stroke-width:2px,color:#E65100
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["MDG FFID"]
        n1["fa:fa-user Create Change Request for Create/Update G/L Account Group"]
        n2[["fa:fa-cog Process and Activate GL Account Group"]]
        n3[["fa:fa-cog Update GL Account Group in the System"]]
        n4(["fa:fa-play Creation of GL Account Group Requested (by Business)"])
        n5(["fa:fa-stop Maintenance of G/L Account Group Completed"])
    end
    n4 --> n1
    n3 --> n5
    n1 --> n2
...
flowchart LR
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["ARC Chair Approver"]
        n2["fa:fa-user Review the GL Cash Account Block/Unblock Request"]
        n15["Send Email to Requestor Including the Minutes and Decision Taken for Each GL..."]
        n31{{"fa:fa-code-branch Request Approved?"}}
    end
    subgraph lane_1["BPM L1 Governance Approver"]
        n12["fa:fa-user Review the Non-Cash Account Request"]
        n14[["fa:fa-cog Update the GL Posting Blocks in the System"]]
        n28(["fa:fa-stop GL Posting Block Maintenance Process Completed"])
        n38{{"fa:fa-code-branch Request Approved?"}}
        n39{{"fa:fa-code-branch exclusiveGateway"}}
    end
    subgraph lane_2["Cash L2 Approver"]
        n1["fa:fa-user Review the GL Cash Request"]
        n16["Receive Email Notification to Add or Inactivate GL Cash Posting Block/Unblock"]
        n30{{"fa:fa-code-branch Request Approved ?"}}
    end
    subgraph lane_3["Cash Representative"]
        n8["fa:fa-user Submit Request for GL Cash Posting Block"]
        n9["fa:fa-user Perform Block / Unblock Validation"]
        n10["fa:fa-user Determine Whether to Re-Submit or Withdraw the Request"]
        n11["fa:fa-user Withdraw the GL Cash Account Request"]
        n13[["fa:fa-cog Route the GL Cash Request to Pre-defined Approvers (Based on the Business..."]]
        n22["Populate a Template Listing Details for the GL Cash Posting Block to be..."]
        n26(["fa:fa-stop Request Withdrawn"])
        n27(["fa:fa-stop Request Withdrawn"])
        n35{{"fa:fa-code-branch exclusiveGateway"}}
        n36{{"fa:fa-code-branch Validation Successful ?"}}
        n37{{"fa:fa-code-branch Decision?"}}
    end
    subgraph lane_4["GateKeeper"]
        n3["fa:fa-user Submit the Non-Cash Block/Unblock Account Request"]
        n4["fa:fa-user Perform Block / Unblock G/L Accounts Validation"]
        n5["fa:fa-user Withdraw the Non-Cash Account Block/Unblock Request"]
        n6["fa:fa-user Route the Non-Cash Account Block/Unblock Request to Pre-defined Approvers..."]
        n7["fa:fa-user Determine Whether to Re-Submit or Withdraw the Request"]
        n24(["fa:fa-stop Request Withdrawn"])
        n25(["fa:fa-stop Request Withdrawn"])
        n32{{"fa:fa-code-branch Validation Successful ?"}}
        n33{{"fa:fa-code-branch exclusiveGateway"}}
        n34{{"fa:fa-code-branch Decision?"}}
    end
    subgraph lane_5["Requestor"]
        n17["Determine if GL Cash or Non- Cash Posting Blocks"]
        n18["Create GL Account Posting Blocks Change Request Template in PowerPoint"]
        n19["Submit the Template to ARC Chair"]
        n20["Present the GL Posting Block Changes in Monthly ARC for Discussion/Review"]
        n23(["fa:fa-play Maintenance of GL Posting Blocks Requested"])
        n29{{"fa:fa-code-branch Type of Account?"}}
    end
    subgraph lane_6["Treasury Operations Manager"]
        n21["Indicate What, Why and When Bank Account Cash GL Block/ Unblock will be Created"]
    end
    n23 --> n17
    n17 --> n29
    n18 --> n19
...
flowchart LR
    ...
    classDef gateway fill:#FFF9C4,stroke:#F57F17,stroke-width:2px,color:#E65100
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["BPM L1 Governance Approver"]
        n6["fa:fa-user Review the Master Data Updates"]
        n7["fa:fa-user Check If Corrections are to be Performed."]
        n21(["fa:fa-stop End of the Master Data Update Process"])
        n28{{"fa:fa-code-branch exclusiveGateway"}}
        n29{{"fa:fa-code-branch Corrections to be Performed ?"}}
    end
    subgraph lane_1["Business Analyst"]
        n14["fa:fa-user Copy the Hierarchy to 'Existing Hierarchy' and Update the Validity Period in..."]
        n15["fa:fa-user Import the Hierarchy Excel file from MDG System in Manage Global Hierarchies..."]
        n23(["fa:fa-stop Hierarchy Maintenance in Manage Global Hierarchies Process Completed"])
    end
    subgraph lane_2["GateKeeper"]
        n5["fa:fa-user Reconcile the Master Data Updates"]
    end
    subgraph lane_3["IT Approver"]
        n13["fa:fa-user Review the Request"]
        n18[["fa:fa-cog Perform Mass Update/ File Upload of G/L Accounts/PC/CC"]]
        n19[["fa:fa-cog Update Master Data in the System"]]
        n32{{"fa:fa-code-branch Request Approved ?"}}
    end
    subgraph lane_4["IT Requestor"]
        n8["fa:fa-user Route the Request to Pre-defined Approvers (Based on the Business Rules..."]
        n9["fa:fa-user Create Change Request for File Upload / Mass Process"]
        n10["fa:fa-user Check If Changes are Not Replicated Properly, Retrigger the Replication Process"]
        n11["fa:fa-user Determine Whether to Resubmit or Withdraw the Request"]
        n12["fa:fa-user Withdraw the Request"]
        n22(["fa:fa-stop Request Withdrawn"])
        n30{{"fa:fa-code-branch Decision?"}}
        n31{{"fa:fa-code-branch Retrigger the Replication ?"}}
    end
    subgraph lane_5["MDG Requestor"]
        n1["fa:fa-user Export the Hierarchy into Excel File from Manage Global Hierarchies Fiori..."]
        n2["fa:fa-user Set report relevancy for Set Based Hierarchies in GUI by using T-code:..."]
        n3["fa:fa-user Replicate Runtime Hierarchy: Schedule jobs in GUI using T-code:HRRP_REP for..."]
        n4["fa:fa-user Import Hierarchy in Fiori MGH App for the First Time in the System"]
        n16[["fa:fa-cog Replicate the Master Data Updates"]]
        n17[["fa:fa-cog Schedule a Weekly Job in GUI to Automatically Execute the Program:..."]]
        n20(["fa:fa-play Master Data Update Initiated"])
        n24{{"fa:fa-code-branch Does Profit Center/Cost Center Hierarchy Need to be Updated?"}}
        n25{{"fa:fa-code-branch Is it a Create or Update Request?"}}
...
flowchart TD
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["MDG-F Requestor"]
        n1["fa:fa-user Create Bank Master Data via Manage Bank App"]
        n2["fa:fa-user Display Modified Bank Master Data in the System via Manage Banks App"]
        n3["fa:fa-user Update Bank Master Data via Manage Bank App"]
        n4["fa:fa-user Mark for Deletion of Bank Master Data via Manage Bank App"]
        n5["fa:fa-user Verify if Changes have Taken Effect via Manage Bank Apps"]
        n6(["fa:fa-play Service now Request Received to Create/Update/Delete Bank Master"])
        n7(["fa:fa-stop Create/Update/Delete of Bank Master Data Process Completed"])
        n8["Requestor Notified that the Bank Master Create/Change/Delete Request has..."]
        n9{{"fa:fa-code-branch Errors Found?"}}
        n10{{"fa:fa-code-branch exclusiveGateway"}}
        n11{{"fa:fa-arrows-alt Activity Type?"}}
