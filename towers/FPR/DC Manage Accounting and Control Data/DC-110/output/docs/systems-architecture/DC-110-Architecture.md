...
**Capability RICEFW — Active Items** (0 of 15 objects)
*Data source: Smartsheet Object Tracker (cached 2026-04-06)*

> **Completion Context:** 15 of 15 objects (100%) are complete/closed. The **0 active items** below require attention. See the **RICEFW Register** for full detail.
>
...
**All 15 objects are completed** — no active items requiring attention.
...
*All 15 objects are completed — no active items to track.*

### 7.2 RAID Log

*Live data from Smartsheet Master RAID Log — extracted 2026-04-06*

**Mapped sub-tower(s):** 3.4 FPR - Intercompany

**RAID Summary:** 16 open items (2 capability-specific, 14 tower-level), 238 closed
...
**Other FPR Tower RAID Items** (14 open):
