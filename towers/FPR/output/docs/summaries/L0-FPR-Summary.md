...
Aggregated current-state: **28** systems, **32** connections, **72** flow hops.
...
Aggregated future-state: **44** systems, **54** connections, **150** flow hops.
