...
Aggregated current-state: **28** systems, **32** connections, **40** flow hops.
...
Aggregated future-state: **44** systems, **54** connections, **118** flow hops.
