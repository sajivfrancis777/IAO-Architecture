...
This **L1** summary aggregates architecture diagrams from **3** L2 capabilities across **Tower: Finance Plan To Report (FPR) · Process: DS Provide Decision Support · R1 – R5**.
