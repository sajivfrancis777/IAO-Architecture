...
| DS-010 Migration Completeness | 100% flow chains validated | All 0 flow chains verified in target state | 0% (pre-migration) | Tower Architect |
...
|---|---------|--------------|-------|-------|----------|
| 1 | DS-010-010_Create_and_Maintain_Master_Data | DS-010-010_Create_and_Maintain_Master_Data | Cost Accountant - Overhead | 1 | 2 |
| 2 | DS-010-020_Post_Primary_Actual_Cost_to_Cost_Centers | DS-010-020_Post_Primary_Actual_Cost_to_Cost_Centers | Cost Accountant | 4 | 2 |
...
**Swim Lanes**: Cost Accountant - Overhead | **Tasks**: 1 | **Gateways**: 2
...
flowchart TD
    ...
    subgraph lane_0["Cost Accountant - Overhead"]
        n1["fa:fa-user Identify Allocator (Sender) and Allocatees (Receiver)"]
        n2(["fa:fa-play Creation and Maintenance of Master Data Initiated"])
        n3(["fa:fa-stop Creation and Maintenance of Master Data Completed"])
        n4{{"fa:fa-arrows-alt parallelGateway"}}
        n5{{"fa:fa-arrows-alt parallelGateway"}}
        n6[["fa:fa-folder-open Create Update Cost Center"]]
        n7[["fa:fa-folder-open Create/Update Profit Center"]]
        n8[["fa:fa-folder-open Create Accounts"]]
        n9[["fa:fa-folder-open Change G/L Accounts"]]
        n10[["fa:fa-folder-open Update Master Data"]]
        n11[["fa:fa-folder-open Maintain Account Groups"]]
        n12[["fa:fa-folder-open Update Statistical Key figures"]]
        n13[["fa:fa-folder-open Create Project Hierarchy (Project Structure)"]]
        n14[["fa:fa-folder-open _Process Work Centers"]]
        n15[["fa:fa-folder-open _Process Routing"]]
        n16[["fa:fa-folder-open _Process Production Version"]]
        n17[["fa:fa-folder-open I Functional Area"]]
    end
    n4 --> n7
    n4 --> n17
    n7 --> n5
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqlVmtv4jgU_StWqopWCpo4D0LzYSUaSLeaGe1qmMeH6WrkJjfgrbEj22nLIv77OpBAk4bOaBcJwj2-59yHHdsbKxUZWJF1fr6hnOoIbQZ6CSsYRGhwTxQMbLQHvhJJyT0DNah8csH1nP6zc8N-8Vy5VVhCVpStK3QOCwHoy62NJobIbKQIV0MFkuYDe1BIuiJyHQsmZOV9BuPcyXfR6qFrITOQRwfHCXEaGCqjHI6wF_qhn1Q8BangWUs0D_Jxng62VXJMPKVLIvUu_VLBR_L8jWZ6aeycMAXGZ6lX7AO5B1bVqGVZYWkpH5tmUFXF4aZh84KklC8M7jsGkoQ_HKHA2W7R9vz8jh-Cos_TO47MJ2VEqSnkSGkDzx41yilj0ZkfT5LAsZWW4gGiM3cWTj3XTqtKIlO6Y1fNHT4BXSx1dC9YVrsOn6oaIrd4tuVz5Dq2XJvfTizg2TFSPHLH7vgQ6TrEMY6bSHme_69Ipq_yM1EPdayZl7jJ9BALB6Mgdl7rNWVO_XCCu30C-UhTeCGaJIk3O7ZqNgqwc1r0OvFGTtwRXRANT2R9FLyK_YNgEoQJDk8K7uN1syzv_5QibQS9WZAEB8HwGicT96SgP8H-uM7Q6CwkKZaIEQ4_nO93ViyURpM0FSXXhGs0RH88glwCye6sv_ak6sOx8c1JlJNhNQfoNgOuab5GE8ZESrSQ6GJu1gHIS0R41sAACl18ghSoEb1sK7oXB8mCmWbFEoimgu_4HwnlGjjhKSCRG1NpE3VKNEG3ZhuhRrpK8PKFnnfUU1oUv6wXi1XB4LWev9k0ekRK8aSGhGlUEEkYA3azn-I7a7t9wQn-A2f0_ZB3bl4HkENRAN-nbza4Iqseu2mKTc9BmjRftjF8i_6uppvFk9MTAuM349dLQ3VIVydIS8IXgG7efThFxE4_s070xcR0ibifuJtZ820CohspyuJVWPfNsHNtlorSNCUMvYfqxV2UEl6JeG-2yjT5b0g1-p2CJDJdrtFFA83Nbp9qI3nZlfT7JX9Urzsohb4J-VDP26t0gp9wP4lSmyOjSxv9hGaemcm2enW-mqjm2VU4seZuUVLyHdG0cWKacuSZrWH_h_toOPzNLNu2iRs73NtBbeKOHdTuzfDe9DpijY29NrseH9XmqHcU447ttO2rtjmuzXFb7KpTh9OxcX9stxl32-O16Xfcu3ZXrqkU-53wQcdut2J37lTdbc7bFuweLhct2KvvAS3Qb87CFhr0oqPmmGuhYS867kWvelHT-14Y98NuP-z1w34_HPTD_SXiQ42Wba1ArgjNrGhj7e7F5u6cQU5Kpq2tbZFSi_map1a0uz9a5W7_mlJijvXVHtz-CwlCjwc=" title="View full diagram">&#128065; View Diagram</a></div>
...
**Swim Lanes**: Cost Accountant | **Tasks**: 4 | **Gateways**: 2
...
flowchart TD
    ...
    subgraph lane_0["Cost Accountant"]
        n1["fa:fa-user Post Procurement Cost (Bulk, Chemicals and Gases)"]
        n2["fa:fa-user Post Burden Expenses"]
        n3["fa:fa-user Post Depreciation Expenses"]
        n4["fa:fa-user Allocate to OCOS WBS/Profit Center/PCOS Tech Node Cost Centers"]
        n5(["fa:fa-play Primary Actual Cost Posting Initiated"])
        n6(["fa:fa-stop Primary Actual Cost Posting Completed"])
        n7["Posted to Central Cost Center (Allocator)"]
        n8["Posted to Common (Shared) Cost Center"]
        n9["Posted to Depreciation Cost Center"]
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqlVl2PokgU_SsVOh27E8zwKcrDJooymWR3pxN7Zh7WzaaEoq10UUWKotU1_ve9JaDC6Cab5YF4D_ec-1HeCwcjESkxQuPx8UA5VSE6DNSG5GQQosEal2Rgohr4jiXFa0bKgfbJBFdL-vfJzfaKnXbTWIxzyvYaXZI3QdC3LyaaApGZqMS8HJZE0mxgDgpJcyz3kWBCau8HMs6s7BSteTQTMiXy4mBZgZ34QGWUkwvsBl7gxZpXkkTwtCOa-dk4SwZHnRwT22SDpTqlX5XkN7z7QVO1ATvDrCTgs1E5-xWvCdM1KllpLKnkR9sMWuo4HBq2LHBC-RvgngWQxPz9AvnW8YiOj48rfg6KXucrjuBKGC7LOclQqQBefCiUUcbCBy-axr5llkqKdxI-OItg7jpmoisJoXTL1M0dbgl926hwLVjauA63uobQKXam3IWOZco93HuxCE8vkaKRM3bG50izwI7sqI2UZdn_igR9la-4fG9iLdzYiefnWLY_8iPrZ722zLkXTO1-n4j8oAm5Eo3j2F1cWrUY-bZ1X3QWuyMr6om-YUW2eH8RnETeWTD2g9gO7grW8fpZVusXKZJW0F34sX8WDGZ2PHXuCnpT2xs3GYLOm8TFBjHMyV_WHysjEqVC0yQRFVeYq5XxZ-2pL26DQ4bDDA9149GL9tV5VBIGlit0Ij_NKvZuogiGmCbwT0eYp-gzjHb53FVzbqjNKphCjha7gnBgdAnuDcKcFJIkFCsq7tG8Lm3KmEjgQJAS6Gv0dYl-zJafoIqMQgFQBZGfXjT8SpIN-h2Gry6rftST9p_O2gWDA36pdwk0UFWY1USdJgwq-gLrDvIkKUg8X2mMLhqlEsW_akQiLxj5WSMACe1DUl2VTlW21Dpv9NSULWTvFMZdqshzaOTTErYISZ-vJbq0SYfWOYW7HNs6HNpSsZRiWw4xU6jAkCwj7HM9JSvjeLwm2f-NBMun_sF9NBz-oqM2tm01QM92erbb2rUZNKZTm-PGHDdirZpb25PGDHqPJz3bbtS9xvZqc3Q16DqDdsF1YOc27N6Gvduwf34ldOBRs707YHDbd3wbntyGob3NHuzCdgsbppETmWOaGuHBOH0EwIdCSjJcMWUcTQNXSiz3PDHC08vSqIoUmHOKYYflNXj8B61GpX8=" title="View full diagram">&#128065; View Diagram</a></div>
...
**Swim Lanes**: Cost Accountant | **Tasks**: 5 | **Gateways**: 7
...
flowchart TD
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["Cost Accountant"]
        n1["fa:fa-user Allocate CPLG Freight Expenses"]
        n2["fa:fa-user Allocate CPLG Warehouse Expenses"]
        n3["fa:fa-user Allocate CPLG Planning and Staff (Additional)"]
        n4["fa:fa-user Allocate to Cost Centers/Profit Centers Based on the Source"]
        n5["fa:fa-user Allocate to Profit Centers"]
        n6(["fa:fa-play Primary Periodic Costs Transfers Initiated"])
        n7(["fa:fa-stop Primary Periodic Costs Transfers Completed"])
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqlVluP2jgY_StWRiNaKWjjXAjkYSUIpKrUSkjMbh9KtTKJDdYYO7KdARbx39chFyYUulqWB8Q5_s75LiRfcrRSkWErsp6fj5RTHYFjT2_wFvci0FshhXs2qIg_kaRoxbDqlTFEcL2gf5_DoJ_vy7CSS9CWskPJLvBaYPDHZxuMjZDZQCGu-gpLSnp2L5d0i-QhFkzIMvoJD4lDztnqo4mQGZaXAMcJYRoYKaMcX2gv9EM_KXUKp4JnHVMSkCFJe6eyOCZ26QZJfS6_UPgr2n-jmd4YTBBT2MRs9JZ9QSvMyh61LEouLeRbMwyqyjzcDGyRo5TyteF9x1AS8dcLFTinEzg9Py95mxS8TJccmE_KkFJTTIDShp69aUAoY9GTH4-TwLGVluIVR0_uLJx6rp2WnUSmdccuh9vfYbre6GglWFaH9ndlD5Gb7225j1zHlgfzfZUL8-ySKR64Q3fYZpqEMIZxk4kQ8r8ymbnKF6Re61wzL3GTaZsLBoMgdn72a9qc-uEYXs8Jyzea4nemSZJ4s8uoZoMAOvdNJ4k3cOIr0zXSeIcOF8NR7LeGSRAmMLxrWOW7rrJYzaVIG0NvFiRBaxhOYDJ27xr6Y-gP6wqNz1qifAMY4vgv5_vSioXSYJymouAacb20flSR5YdDE0BQRFC_HDwYMyZS0xqI518-gUSe_0Mw2-eYK6y6UvdX0m9I4o0wB3fE3q_Ec1M7N3cCQDwDC40IAR_GWUY1FRyxj10n_46TFuDceYy5xlL9ZqZLaAvBxGymDAgOzGoCC1HIFHd9g_u-XauubPCh1eXMXCDzaheBuVlbIqPpuSgFXswNr0hZyGezM6kxzozPx3dG4cVIaZH_u1EstjnDPxsNj8fGCEkpdqqPmAY5kogxzD5VF_LSOp3eaUYPaKDziAg-InIfEXmPiPz_JjJ7svrBB6Df_90Mv4bDCsIu9GoI69N6KXC3xk24V2O3xqMKB428Pvcb7Fc4bLBT4VGN62PYxAdXuK7OvZLDtlx4Tbh3iNGVYvRu65VtN9u-Q7u3ae827d-mg9v0oH1sduiwfsJ1yGGz5Tvs6CZrZnSThrdp9zbt3ab9hrZsa4vlFtHMio7W-aXKvHhlmKCCaetkW6jQYnHgqRWdXz6sIs-MckqReSZsK_L0D39gDfc=" title="View full diagram">&#128065; View Diagram</a></div>
...
**Swim Lanes**: Cost Accountant | **Tasks**: 6 | **Gateways**: 1
...
flowchart TD
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["Cost Accountant"]
        n1["fa:fa-user Allocate HR Benefits Using Head Count"]
        n2["fa:fa-user IP - Capture HR Benefits"]
        n3["fa:fa-user Allocate to IF LOB Cost Center"]
        n4["fa:fa-user Allocate to IP LOB Cost Center"]
        n5["fa:fa-user IF - Capture HR Benefits"]
        n6["fa:fa-user Allocate HR Benefits Using Head Count"]
        n7(["fa:fa-play Update of Statistical Key Figures Initiated"])
        n8(["fa:fa-play Update of Statistical Key Figures Initiated"])
        n9(["fa:fa-stop Update of Statistical Key Figures Completed"])
        n10{{"fa:fa-arrows-alt parallelGateway"}}
    end
    n7 --> n2
    n2 --> n1
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqtlW2P2jgQx7-KldWKqxSkPBI2L06CQK6rtrpV6bYvyulkkjFYa-zIdpaliO9-NgnQULaq1MsLxPwz85sH2ZOdU4gSnNS5vd1RTnWKdj29gjX0UtRbYAU9FzXCZywpXjBQPetDBNcz-u3g5kfVi3WzWo7XlG2tOoOlAPR476KRCWQuUpirvgJJSc_tVZKusdxmgglpvW9gSDxyyNa-GgtZgjw7eF7iF7EJZZTDWQ6TKIlyG6egELzsQElMhqTo7W1xTGyKFZb6UH6t4AN--UJLvTI2wUyB8VnpNXuPF8Bsj1rWVitq-XwcBlU2DzcDm1W4oHxp9MgzksT86SzF3n6P9re3c35Kij5N5hyZp2BYqQkQpLSRp88aEcpYehNlozz2XKWleIL0JpgmkzBwC9tJalr3XDvc_gbocqXThWBl69rf2B7SoHpx5UsaeK7cmt-LXMDLc6ZsEAyD4SnTOPEzPztmIoT8ViYzV_kJq6c21zTMg3xyyuXHgzjzfuQd25xEyci_nBPIZ1rAd9A8z8PpeVTTQex7r0PHeTjwsgvoEmvY4O0ZeJdFJ2AeJ7mfvAps8l1WWS8epCiOwHAa5_EJmIz9fBS8CoxGfjRsKzScpcTVCjHM4V_v69zJhNJoVBSi5hpzPXf-aTztw33jQHBKcN8OHo0YE4VpDb39iMbAgVCt0KMypxK9BVyizEK6hKBLuH9AfZThSteyQ-kGha-k1QLd5-j932N0qDoDrkF2Q6OfhD78PDS-KDX_lVIHvz2h5I8TomLmzDxWpQUIgmYaa6o0LTBD72CLcro0tSh0b_YoNT6lAb35jjT830h3Z5LSovoFUibWFYMfSb632x1RWEqxUX3MNKqwxIwB-6u5KHNnv2-CzCpp_vAE9ft_mgPUmkFjttfXcBv7rrXD9nV7cfiwsePWHDRm2JpxYw6OsMaMWjPqsg6X0Dodl09HDq7L4XU5ui7H1-XBdTk5LfeOPLwu37XruduMd9xRjuusQa4xLZ105xy-xOZrXQLBNdPO3nVwrcVsywsnPXyxnPpwFiYUm0WybsT9f7GSfus=" title="View full diagram">&#128065; View Diagram</a></div>
...
---
*DS-010 — Architecture Document (TOGAF BDAT) · Finance Plan To Report · Generated: April 2026*
