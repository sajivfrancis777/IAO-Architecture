...
The following data entities are derived from the system integration flows for DS-010. Tower architects should validate ownership and classification.
...
Integration patterns identified from the system flow analysis for DS-010:
...
Platform landscape inferred from integrated systems for DS-010:
