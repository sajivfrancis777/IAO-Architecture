...
flowchart TB
    ...
    subgraph E2E88CDACL_e_g_Azure_SQL[" "]
        ...
        E2E88CDAD_e_g_Azure_SQL[("🗄️ e.g. Azure SQL")]:::dbCloud
        E2E88CDAA_e_g_XEUS -.-> E2E88CDAD_e_g_Azure_SQL
    end
    style E2E88CDACL_e_g_Azure_SQL fill:#E8F5E9,stroke:#388E3C,stroke-width:1px

    subgraph E2E88CDACL_e_g_SAP_HANA[" "]
        direction TB
        E2E88CDAA_e_g_MES_300["e.g. MES 300"]:::appBox
        E2E88CDAD_e_g_SAP_HANA[("🗄️ e.g. SAP HANA")]:::dbData
        E2E88CDAA_e_g_MES_300 -.-> E2E88CDAD_e_g_SAP_HANA
    end
    style E2E88CDACL_e_g_SAP_HANA fill:#E3F2FD,stroke:#1976D2,stroke-width:1px
...
flowchart TB
    ...
    subgraph E2E88FDACL_e_g_Azure_SQL[" "]
        ...
        E2E88FDAD_e_g_Azure_SQL[("🗄️ e.g. Azure SQL")]:::dbCloud
        E2E88FDAA_e_g_XEUS -.-> E2E88FDAD_e_g_Azure_SQL
    end
    style E2E88FDACL_e_g_Azure_SQL fill:#E8F5E9,stroke:#388E3C,stroke-width:1px

    subgraph E2E88FDACL_e_g_SAP_HANA[" "]
        direction TB
        E2E88FDAA_e_g_MES_300["e.g. MES 300"]:::appBox
        E2E88FDAD_e_g_SAP_HANA[("🗄️ e.g. SAP HANA")]:::dbData
        E2E88FDAA_e_g_MES_300 -.-> E2E88FDAD_e_g_SAP_HANA
    end
    style E2E88FDACL_e_g_SAP_HANA fill:#E3F2FD,stroke:#1976D2,stroke-width:1px
...
flowchart TB
    ...
    subgraph AL["🔵 APPLICATION LAYER"]
        direction LR
        subgraph E2E88CLN_Boundary_Applications[" ⬛ Boundary Applications"]
            direction LR
            E2E88C_ALRANK_0[ ]:::rankAnchor
    ...
    style E2E88CLN_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:1px
...
flowchart TB
    ...
    subgraph AL["🔵 APPLICATION LAYER"]
        direction LR
        subgraph E2E88FLN_Boundary_Applications[" ⬛ Boundary Applications"]
            direction LR
            E2E88F_ALRANK_0[ ]:::rankAnchor
    ...
    style E2E88FLN_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:1px
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqVlntvmzoUwL-KxZS_btLyCAlFVSUe5qp3JK2abb3TmJADTmLNMQjD2qzrd78G50FIs-06EgGfc37HPj4-9ouSZClWbKXXeyGMlDZ4iZRyhdc4UmwQKXPExVtfvHGcVAUpNyH-jqkU0izbSRuTT6ggaE4xr8WCs8hYOSM_tihtlD9L5bo_QGtCN1Iyw8sMg4-3feAIAO0DjhgfcFyQRaS8NhY0e0pWqCi35IrjCXp-JGm5qnsWiHJc663KNQ3RHNNmCGVRNb1MTHGWo4SwZd09VOvOArFvrU5TfX0Fr71exPa-wAc3YkC0Xg8MBmJsyYpMUImBcaGDv4Dzoyow4OWGYpBQxDnmQk1aNN8-XoB5xQnDnIOmLQil9rtANNfo87LIvmHxeeVYurn9HDzVc7L1_LmfZDQr7HeqqnaYKM_BoUmm50EzCPZMVR1b_vAXTMMZeR1sikrUxbquDwN3j9XMkempx1ithfWHY0fbiVPERRQLtBHBBWbH2ZqkKcVPSESwFReouvreGRyZmqqenYMbGCO1Owec0ZPQBIHn-wesN9It3TqPHWue1sVyhHgXCzUXwvEeO3a1wNHPYoeONrS62IRmVfr_I653I97BZiwv8LqTHxYceVd7rA7HvnF-tJprQr2bdvWGcViyyoo9lmUM75jNu7QvhSrPxdqysl_v9QEXRaBOlIhJJq_mywLlK-CEXyIlqlLLSMUzNUzg3N-Ht57z4fZuCkLnM3yIlK_SqG4pKXBSkoyB8OHQu8dBHVpWEE5jN6tYiopN7OQ5JQmqTbhwBaJKn2tzsJODtvzI03lvdZOOYid8cKbvY_UL-Grb9iFAbyrjeBlP4Cw2VLU96QSPAL5YXgAhA0ImRiFYYo-fhfwLP87eJNSCN8wxSw8fkjN5bEhNCYtnuPhOEhy7FT9aDW0ssbLQbbWA0JI-Dlu4S_dhQ_cyXsaQioOBlTft8SZDCa4VwFbhel5c3lyTGymYfQKX4NbPEvH3z-xuen1JbqTXukpJf8205OtphEUlvvkZKQ3Nb5ZRkJz7W_EMCBUn0s_fRKINPqdTO-kuTD2kbZI3J4MbHqq-36oXZ6p-29TZmUIj0AP_d8X92O-vt8IObAUmPFQFw7Kg4Z2U95NdG-KlCP5RCqYqCOHfcOr_wXYNY7HJuwncGt0bKRzGk8dubk4O-Xc2H8PYh93U8-tzDrJS3GW6KSVN4J2sSvooHQrFdJAtBiFZbN2II6aVf4eAy6DsFtusf_vAXl1dnURV6StrXKwRSRX7Rd6fxDUsxQtU0VLcehRUldlswxLFbu4xSpWLgWKfILEIa9n5-h9xogcn" title="View full diagram">&#128065; View Diagram</a></div>
...
flowchart TB
    ...
    style E2E88CPLP_e_g_Azure_PaaS fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C

    subgraph E2E88CPLP_e_g_S_4_HANA_2023["🖥️ e.g. S/4 HANA 2023"]
        direction LR
        E2E88CPLA_e_g_MES_300["e.g. MES 300"]:::appBox
    end
    style E2E88CPLP_e_g_S_4_HANA_2023 fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20

    E2E88CPLP_e_g_S_4_HANA_2023 ==>|"e.g. Direct / API / File"| E2E88CPLP_e_g_Azure_PaaS

    subgraph E2E88CPLLegend["📐 PLATFORM LEGEND"]
        direction LR
        E2E88CPLLC["☁️ Cloud"]
        E2E88CPLLS["🔮 SaaS"]
        E2E88CPLLO["🏢 On-Prem"]
        E2E88CPLLD["💾 Data Platform"]
        E2E88CPLLM["🔗 Middleware"]
    end
    style E2E88CPLLegend fill:#F5F5F5,stroke:#999,stroke-width:1px
    style E2E88CPLLC fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C
    style E2E88CPLLS fill:#E1BEE7,stroke:#7B1FA2,stroke-width:3px,color:#4A148C
    style E2E88CPLLO fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20
    style E2E88CPLLD fill:#B2EBF2,stroke:#00838F,stroke-width:3px,color:#004D40
    style E2E88CPLLM fill:#FFE0B2,stroke:#E65100,stroke-width:3px,color:#BF360C
```
...
flowchart TB
    ...
    style E2E88FPLP_e_g_Azure_PaaS fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C

    subgraph E2E88FPLP_e_g_S_4_HANA_2023["🖥️ e.g. S/4 HANA 2023"]
        direction LR
        E2E88FPLA_e_g_MES_300["e.g. MES 300"]:::appBox
    end
    style E2E88FPLP_e_g_S_4_HANA_2023 fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20

    E2E88FPLP_e_g_S_4_HANA_2023 ==>|"e.g. Direct / API / File"| E2E88FPLP_e_g_Azure_PaaS

    subgraph E2E88FPLLegend["📐 PLATFORM LEGEND"]
        direction LR
        E2E88FPLLC["☁️ Cloud"]
        E2E88FPLLS["🔮 SaaS"]
        E2E88FPLLO["🏢 On-Prem"]
        E2E88FPLLD["💾 Data Platform"]
        E2E88FPLLM["🔗 Middleware"]
    end
    style E2E88FPLLegend fill:#F5F5F5,stroke:#999,stroke-width:1px
    style E2E88FPLLC fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C
    style E2E88FPLLS fill:#E1BEE7,stroke:#7B1FA2,stroke-width:3px,color:#4A148C
    style E2E88FPLLO fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20
    style E2E88FPLLD fill:#B2EBF2,stroke:#00838F,stroke-width:3px,color:#004D40
    style E2E88FPLLM fill:#FFE0B2,stroke:#E65100,stroke-width:3px,color:#BF360C
```
