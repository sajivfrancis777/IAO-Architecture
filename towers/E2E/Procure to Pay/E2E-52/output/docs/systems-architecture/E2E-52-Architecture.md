...
flowchart TB
    ...
    subgraph AL["🔵 APPLICATION LAYER"]
        direction LR
        subgraph E2E52CLN_e_g_Boundary_Apps[" ⬛ e.g. Boundary Apps"]
            direction LR
            E2E52C_e_g_XEUS["📦 e.g. XEUS"]:::app
        end
        subgraph E2E52CLN_e_g_MES_Systems[" ⬛ e.g. MES Systems"]
            direction LR
...
flowchart TB
    ...
    subgraph AL["🔵 APPLICATION LAYER"]
        direction LR
        subgraph E2E52FLN_e_g_Boundary_Apps[" ⬛ e.g. Boundary Apps"]
            direction LR
            E2E52F_e_g_XEUS["📦 e.g. XEUS"]:::app
        end
        subgraph E2E52FLN_e_g_MES_Systems[" ⬛ e.g. MES Systems"]
            direction LR
