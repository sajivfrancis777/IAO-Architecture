...
flowchart LR
    ...
    subgraph lane_2["SAP S/4 Intel Foundry Virtual Plant LE101"]
        n2["Create/Release Production Order"]
...
flowchart TD
    ...
    subgraph lane_1["SAP S/4 Intel Product (Virtual Site)"]
...
flowchart LR
    ...
    subgraph lane_1["Intel Product Virtual site"]
        n5["Perform Outbound Delivery"]
        n6["Perform Pick and Pack Updates"]
        n7["Post Goods Issue (Virtual)"]
        n8["IC Invoice Trading Str Dependent"]
    ...
    subgraph lane_2["Intel Product Warehouse"]
...
flowchart TB
    ...
    subgraph E2E57CDACL_e_g_Azure_SQL[" "]
        ...
        E2E57CDAD_e_g_Azure_SQL[("🗄️ e.g. Azure SQL")]:::dbCloud
        E2E57CDAA_e_g_XEUS -.-> E2E57CDAD_e_g_Azure_SQL
    end
    style E2E57CDACL_e_g_Azure_SQL fill:#E8F5E9,stroke:#388E3C,stroke-width:1px

    subgraph E2E57CDACL_e_g_SAP_HANA[" "]
        direction TB
        E2E57CDAA_e_g_MES_300["e.g. MES 300"]:::appBox
        E2E57CDAD_e_g_SAP_HANA[("🗄️ e.g. SAP HANA")]:::dbData
        E2E57CDAA_e_g_MES_300 -.-> E2E57CDAD_e_g_SAP_HANA
    end
    style E2E57CDACL_e_g_SAP_HANA fill:#E3F2FD,stroke:#1976D2,stroke-width:1px
...
flowchart TB
    ...
    subgraph E2E57FDACL_e_g_Azure_SQL[" "]
        ...
        E2E57FDAD_e_g_Azure_SQL[("🗄️ e.g. Azure SQL")]:::dbCloud
        E2E57FDAA_e_g_XEUS -.-> E2E57FDAD_e_g_Azure_SQL
    end
    style E2E57FDACL_e_g_Azure_SQL fill:#E8F5E9,stroke:#388E3C,stroke-width:1px

    subgraph E2E57FDACL_e_g_SAP_HANA[" "]
        direction TB
        E2E57FDAA_e_g_MES_300["e.g. MES 300"]:::appBox
        E2E57FDAD_e_g_SAP_HANA[("🗄️ e.g. SAP HANA")]:::dbData
        E2E57FDAA_e_g_MES_300 -.-> E2E57FDAD_e_g_SAP_HANA
    end
    style E2E57FDACL_e_g_SAP_HANA fill:#E3F2FD,stroke:#1976D2,stroke-width:1px
...
flowchart TB
    ...
    subgraph AL["🔵 APPLICATION LAYER"]
        direction LR
        subgraph E2E57CLN_Boundary_Applications[" ⬛ Boundary Applications"]
            direction LR
            E2E57C_ALRANK_0[ ]:::rankAnchor
    ...
    style E2E57CLN_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:1px
...
flowchart TB
    ...
    subgraph AL["🔵 APPLICATION LAYER"]
        direction LR
        subgraph E2E57FLN_Boundary_Applications[" ⬛ Boundary Applications"]
            direction LR
            E2E57F_ALRANK_0[ ]:::rankAnchor
    ...
    style E2E57FLN_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:1px
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqVlntvmzoUwL-KxZS_btLyCAlFVSQe5ip3JK2abb3TmJADTmLNMQjD2qzrd78G50Fps-06EgGfc37HPj4-9pOSZClWbKXXeyKMlDZ4ipRyg7c4UmwQKUvExVtfvHGcVAUpdyH-jqkU0iw7SBuTT6ggaEkxr8WCs8pYuSA_9ihtlD9K5bo_QFtCd1KywOsMg4_TPnAEgPYBR4wPOC7IKlKeGwuaPSQbVJR7csXxDD3ek7Tc1D0rRDmu9TblloZoiWkzhLKoml4mprjIUULYuu4eqnVngdi3VqepPj-D514vYkdf4IMbMSBarwcGAzG2ZENmqMTAuNDBX8D5URUY8HJHMUgo4hxzoSYtmm8fr8Cy4oRhzkHTVoRS-10gmmv0eVlk37D4vHIs3dx_Dh7qOdl6_thPMpoV9jtVVTtMlOfg1CTT86AZBEemqo4tf_gLpuGMvA42RSXqYl3Xh4F7xGrmyPTUl1ithfWHY0c7iFPERRQLtBPBBWbH2ZakKcUPSESwFReouvrRGRyZmqqenYMbGCO1Owec0VehCQLP909Yb6RbunUeO9Y8rYvlCPEuFmouhOMjduxqgaOfxQ4dbWh1sQnNqvT_R1zvRryDzVhe4G0nPyw48q6OWB2OfeP8aDXXhHo37eoN47BkkxVHLMsYPjCbd2lfClWei7VlZb_e6wMuikCdKBGTTF4t1wXKN8AJv0RKVKWWkYpnapjAub0Np57zYXozB6HzGd5FyldpVLeUFDgpScZAeHfqPeKgDs1xEM5jN6tYiopd7OQ5JQmqTbhwBaJKX2pLcJCDtvyFp_Pe6iYdxU5458zfx-oX8NW27VOA3lTG8TqewUVsqGp70gkeAXyxvgBCBoRMjEKwxB4_C_kXfly8SagFb5hjlp4-JGd235CaEhYvcPGdJDh2K_5iNbSxxMpCt9cCQkv6OG3hLt2HDd3LeBlDKg4GVk7a402GElwrgL3C9bK4nFyTiRQsPoFLMPWzRPz9s7iZX1-SifRaVynpr5mWfH0dYVGJJz8jpaH5zTIKknM7Fc-AUHEi_fxNJNrgczq1k-7C1EPaJ3lzMrjhqer7rXpxpuq3TZ2DKTQCPfB_V9xf-v31VjiArcCEp6pgWBY0vFfl_dWuDfFaBP9FCqYqCOHfcO7_wXYNY7HJuwncGt0bKRzGs_tubs5O-Xc2H8PYh93U8-tzDrJS3GW6KSVN4I2sSvooHQrFdJCtBiFZ7d2II6aVf6eAy6AcFtusf8fAXl1dvYqq0le2uNgikir2k7w_iWtYileooqW49SioKrPFjiWK3dxjlCoXA8U-QWIRtrLz-T_aggb7" title="View full diagram">&#128065; View Diagram</a></div>
...
flowchart TB
    ...
    style E2E57CPLP_e_g_Azure_PaaS fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C

    subgraph E2E57CPLP_e_g_S_4_HANA_2023["🖥️ e.g. S/4 HANA 2023"]
        direction LR
        E2E57CPLA_e_g_MES_300["e.g. MES 300"]:::appBox
    end
    style E2E57CPLP_e_g_S_4_HANA_2023 fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20

    E2E57CPLP_e_g_S_4_HANA_2023 ==>|"e.g. Direct / API / File"| E2E57CPLP_e_g_Azure_PaaS

    subgraph E2E57CPLLegend["📐 PLATFORM LEGEND"]
        direction LR
        E2E57CPLLC["☁️ Cloud"]
        E2E57CPLLS["🔮 SaaS"]
        E2E57CPLLO["🏢 On-Prem"]
        E2E57CPLLD["💾 Data Platform"]
        E2E57CPLLM["🔗 Middleware"]
    end
    style E2E57CPLLegend fill:#F5F5F5,stroke:#999,stroke-width:1px
    style E2E57CPLLC fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C
    style E2E57CPLLS fill:#E1BEE7,stroke:#7B1FA2,stroke-width:3px,color:#4A148C
    style E2E57CPLLO fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20
    style E2E57CPLLD fill:#B2EBF2,stroke:#00838F,stroke-width:3px,color:#004D40
    style E2E57CPLLM fill:#FFE0B2,stroke:#E65100,stroke-width:3px,color:#BF360C
```
...
flowchart TB
    ...
    style E2E57FPLP_e_g_Azure_PaaS fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C

    subgraph E2E57FPLP_e_g_S_4_HANA_2023["🖥️ e.g. S/4 HANA 2023"]
        direction LR
        E2E57FPLA_e_g_MES_300["e.g. MES 300"]:::appBox
    end
    style E2E57FPLP_e_g_S_4_HANA_2023 fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20

    E2E57FPLP_e_g_S_4_HANA_2023 ==>|"e.g. Direct / API / File"| E2E57FPLP_e_g_Azure_PaaS

    subgraph E2E57FPLLegend["📐 PLATFORM LEGEND"]
        direction LR
        E2E57FPLLC["☁️ Cloud"]
        E2E57FPLLS["🔮 SaaS"]
        E2E57FPLLO["🏢 On-Prem"]
        E2E57FPLLD["💾 Data Platform"]
        E2E57FPLLM["🔗 Middleware"]
    end
    style E2E57FPLLegend fill:#F5F5F5,stroke:#999,stroke-width:1px
    style E2E57FPLLC fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C
    style E2E57FPLLS fill:#E1BEE7,stroke:#7B1FA2,stroke-width:3px,color:#4A148C
    style E2E57FPLLO fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20
    style E2E57FPLLD fill:#B2EBF2,stroke:#00838F,stroke-width:3px,color:#004D40
    style E2E57FPLLM fill:#FFE0B2,stroke:#E65100,stroke-width:3px,color:#BF360C
```
