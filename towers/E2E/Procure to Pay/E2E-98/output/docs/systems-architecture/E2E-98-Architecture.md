...
flowchart TB
    ...
    subgraph E2E98CDACL_e_g_Azure_SQL[" "]
        ...
        E2E98CDAD_e_g_Azure_SQL[("🗄️ e.g. Azure SQL")]:::dbCloud
        E2E98CDAA_e_g_XEUS -.-> E2E98CDAD_e_g_Azure_SQL
    end
    style E2E98CDACL_e_g_Azure_SQL fill:#E8F5E9,stroke:#388E3C,stroke-width:1px

    subgraph E2E98CDACL_e_g_SAP_HANA[" "]
        direction TB
        E2E98CDAA_e_g_MES_300["e.g. MES 300"]:::appBox
        E2E98CDAD_e_g_SAP_HANA[("🗄️ e.g. SAP HANA")]:::dbData
        E2E98CDAA_e_g_MES_300 -.-> E2E98CDAD_e_g_SAP_HANA
    end
    style E2E98CDACL_e_g_SAP_HANA fill:#E3F2FD,stroke:#1976D2,stroke-width:1px
...
flowchart TB
    ...
    subgraph E2E98FDACL_e_g_Azure_SQL[" "]
        ...
        E2E98FDAD_e_g_Azure_SQL[("🗄️ e.g. Azure SQL")]:::dbCloud
        E2E98FDAA_e_g_XEUS -.-> E2E98FDAD_e_g_Azure_SQL
    end
    style E2E98FDACL_e_g_Azure_SQL fill:#E8F5E9,stroke:#388E3C,stroke-width:1px

    subgraph E2E98FDACL_e_g_SAP_HANA[" "]
        direction TB
        E2E98FDAA_e_g_MES_300["e.g. MES 300"]:::appBox
        E2E98FDAD_e_g_SAP_HANA[("🗄️ e.g. SAP HANA")]:::dbData
        E2E98FDAA_e_g_MES_300 -.-> E2E98FDAD_e_g_SAP_HANA
    end
    style E2E98FDACL_e_g_SAP_HANA fill:#E3F2FD,stroke:#1976D2,stroke-width:1px
...
flowchart TB
    ...
    subgraph AL["🔵 APPLICATION LAYER"]
        direction LR
        subgraph E2E98CLN_Boundary_Applications[" ⬛ Boundary Applications"]
            direction LR
            E2E98C_ALRANK_0[ ]:::rankAnchor
    ...
    style E2E98CLN_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:1px
...
flowchart TB
    ...
    subgraph AL["🔵 APPLICATION LAYER"]
        direction LR
        subgraph E2E98FLN_Boundary_Applications[" ⬛ Boundary Applications"]
            direction LR
            E2E98F_ALRANK_0[ ]:::rankAnchor
    ...
    style E2E98FLN_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:1px
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqVlntvmzoUwL-KxZS_btLyCAlBVSUe5qp3JK2abb3TmJADTmLNMQjD2qzLd78G50Fps-06EgGfc37HPj4-9rOSZClWbKXXeyaMlDZ4jpRyjTc4UmwQKQvExVtfvHGcVAUptyH-jqkU0iw7SBuTT6ggaEExr8WCs8xYOSc_9ihtlD9J5bo_QBtCt1Iyx6sMg483feAIAO0DjhgfcFyQZaTsGguaPSZrVJR7csXxFD09kLRc1z1LRDmu9dblhoZogWkzhLKoml4mpjjPUULYqu4eqnVngdi3Vqep7nZg1-tF7OgLfHAjBkTr9cBgIMaWrMkUlRgYFzr4Czg_qgIDXm4pBglFnGMu1KRF8-3jJVhUnDDMOWjaklBqvwtEc40-L4vsGxafE8fSzf3n4LGek63nT_0ko1lhv1NVtcNEeQ5OTTI9D5pBcGSq6tjyh79gGs7I62BTVKIu1nV9GLhHrGaOTE99idVaWH84drSDOEVcRLFAWxFcYHacbUiaUvyIRARbcYGqqx-dwZGpqerZObiBMVK7c8AZfRWaIPB8_4T1RrqlW-exY83TuliOEO9ioeZCOD5ix64WOPpZ7NDRhlYXm9CsSv9_xPVuxDvYjOUF3nTyw4Ijb3LE6nDsG-dHq7km1LtpV28YhyXrrDhiWcbwgdm8S_tSqPJcrC0r-_VeH3BRBOpEiZhk8mqxKlC-Bk74JVKiKrWMVDxTwwTO3V144zkfbm5nIHQ-w_tI-SqN6paSAiclyRgI70-9RxzU4cQKwlnsZhVLUbGNnTynJEG1CReuQFTpC20BDnLQlr_wdN5b3aSj2Anvndn7WP0Cvtq2fQrQm8o4XsVTOI8NVW1POsEjgC9WF0DIgJCJUQiW2ONnIf_Cj_M3CbXgDXPM0tOH5EwfGlJTwuI5Lr6TBMduxV-shjaWWFno9lpAaEkfpy3cpfuwoXsZL2NIxcHAyuv2eJOhBNcKYK9wtSgur6_ItRTMP4FLcONnifj7Z347u7ok19JrXaWkv2Za8vV1hEUlvv4ZKQ3Nb5ZRkJy7G_EMCBUn0s_fRKINPqdTO-kuTD2kfZI3J4Mbnqq-36oXZ6p-29Q5mEIj0AP_d8X9pd9fb4UD2ApMeKoKhmVBw3tV3l_t2hCvRPBfpGCqghD-DWf-H2zXMBabvJvArdG9kcJhPH3o5ub0lH9n8zGMfdhNPb8-5yArxV2mm1LSBN7KqqSP0qFQTAfZchCS5d6NOGJa-XcKuAzKYbHN-ncM7GQyeRVVpa9scLFBJFXsZ3l_EtewFC9RRUtx61FQVWbzLUsUu7nHKFUuBop9gsQibGTn7j-XaQcy" title="View full diagram">&#128065; View Diagram</a></div>
...
flowchart TB
    ...
    style E2E98CPLP_e_g_Azure_PaaS fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C

    subgraph E2E98CPLP_e_g_S_4_HANA_2023["🖥️ e.g. S/4 HANA 2023"]
        direction LR
        E2E98CPLA_e_g_MES_300["e.g. MES 300"]:::appBox
    end
    style E2E98CPLP_e_g_S_4_HANA_2023 fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20

    E2E98CPLP_e_g_S_4_HANA_2023 ==>|"e.g. Direct / API / File"| E2E98CPLP_e_g_Azure_PaaS

    subgraph E2E98CPLLegend["📐 PLATFORM LEGEND"]
        direction LR
        E2E98CPLLC["☁️ Cloud"]
        E2E98CPLLS["🔮 SaaS"]
        E2E98CPLLO["🏢 On-Prem"]
        E2E98CPLLD["💾 Data Platform"]
        E2E98CPLLM["🔗 Middleware"]
    end
    style E2E98CPLLegend fill:#F5F5F5,stroke:#999,stroke-width:1px
    style E2E98CPLLC fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C
    style E2E98CPLLS fill:#E1BEE7,stroke:#7B1FA2,stroke-width:3px,color:#4A148C
    style E2E98CPLLO fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20
    style E2E98CPLLD fill:#B2EBF2,stroke:#00838F,stroke-width:3px,color:#004D40
    style E2E98CPLLM fill:#FFE0B2,stroke:#E65100,stroke-width:3px,color:#BF360C
```
...
flowchart TB
    ...
    style E2E98FPLP_e_g_Azure_PaaS fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C

    subgraph E2E98FPLP_e_g_S_4_HANA_2023["🖥️ e.g. S/4 HANA 2023"]
        direction LR
        E2E98FPLA_e_g_MES_300["e.g. MES 300"]:::appBox
    end
    style E2E98FPLP_e_g_S_4_HANA_2023 fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20

    E2E98FPLP_e_g_S_4_HANA_2023 ==>|"e.g. Direct / API / File"| E2E98FPLP_e_g_Azure_PaaS

    subgraph E2E98FPLLegend["📐 PLATFORM LEGEND"]
        direction LR
        E2E98FPLLC["☁️ Cloud"]
        E2E98FPLLS["🔮 SaaS"]
        E2E98FPLLO["🏢 On-Prem"]
        E2E98FPLLD["💾 Data Platform"]
        E2E98FPLLM["🔗 Middleware"]
    end
    style E2E98FPLLegend fill:#F5F5F5,stroke:#999,stroke-width:1px
    style E2E98FPLLC fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C
    style E2E98FPLLS fill:#E1BEE7,stroke:#7B1FA2,stroke-width:3px,color:#4A148C
    style E2E98FPLLO fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20
    style E2E98FPLLD fill:#B2EBF2,stroke:#00838F,stroke-width:3px,color:#004D40
    style E2E98FPLLM fill:#FFE0B2,stroke:#E65100,stroke-width:3px,color:#BF360C
```
