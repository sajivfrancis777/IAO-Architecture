...
flowchart TB
    ...
    subgraph AL["🔵 APPLICATION LAYER"]
        direction LR
        subgraph E2E46CLN_e_g_Boundary_Apps[" ⬛ e.g. Boundary Apps"]
            direction LR
            E2E46C_e_g_XEUS["📦 e.g. XEUS"]:::app
        end
        subgraph E2E46CLN_e_g_MES_Systems[" ⬛ e.g. MES Systems"]
            direction LR
...
flowchart TB
    ...
    subgraph AL["🔵 APPLICATION LAYER"]
        direction LR
        subgraph E2E46FLN_e_g_Boundary_Apps[" ⬛ e.g. Boundary Apps"]
            direction LR
            E2E46F_e_g_XEUS["📦 e.g. XEUS"]:::app
        end
        subgraph E2E46FLN_e_g_MES_Systems[" ⬛ e.g. MES Systems"]
            direction LR
