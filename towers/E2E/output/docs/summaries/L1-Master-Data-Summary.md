...
This **L1** summary aggregates architecture diagrams from **4** L2 capabilities across **Tower: End-to-End Integrated Processes (E2E) · Process: Master Data · R1 – R5**.
...
Aggregated current-state: **2** systems, **1** connections, **4** flow hops.
...
Aggregated future-state: **2** systems, **1** connections, **4** flow hops.
