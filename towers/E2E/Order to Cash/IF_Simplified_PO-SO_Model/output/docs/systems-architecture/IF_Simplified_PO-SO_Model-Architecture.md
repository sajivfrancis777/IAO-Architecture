...
flowchart TB
    ...
    subgraph IF_Simplified_POSO_ModelCDACL_e_g_Azure_SQL[" "]
        ...
        IF_Simplified_POSO_ModelCDAD_e_g_Azure_SQL[("🗄️ e.g. Azure SQL")]:::dbCloud
        IF_Simplified_POSO_ModelCDAA_e_g_XEUS -.-> IF_Simplified_POSO_ModelCDAD_e_g_Azure_SQL
    end
    style IF_Simplified_POSO_ModelCDACL_e_g_Azure_SQL fill:#E8F5E9,stroke:#388E3C,stroke-width:1px

    subgraph IF_Simplified_POSO_ModelCDACL_e_g_SAP_HANA[" "]
        direction TB
        IF_Simplified_POSO_ModelCDAA_e_g_MES_300["e.g. MES 300"]:::appBox
        IF_Simplified_POSO_ModelCDAD_e_g_SAP_HANA[("🗄️ e.g. SAP HANA")]:::dbData
        IF_Simplified_POSO_ModelCDAA_e_g_MES_300 -.-> IF_Simplified_POSO_ModelCDAD_e_g_SAP_HANA
    end
    style IF_Simplified_POSO_ModelCDACL_e_g_SAP_HANA fill:#E3F2FD,stroke:#1976D2,stroke-width:1px
...
flowchart TB
    ...
    subgraph IF_Simplified_POSO_ModelFDACL_e_g_Azure_SQL[" "]
        ...
        IF_Simplified_POSO_ModelFDAD_e_g_Azure_SQL[("🗄️ e.g. Azure SQL")]:::dbCloud
        IF_Simplified_POSO_ModelFDAA_e_g_XEUS -.-> IF_Simplified_POSO_ModelFDAD_e_g_Azure_SQL
    end
    style IF_Simplified_POSO_ModelFDACL_e_g_Azure_SQL fill:#E8F5E9,stroke:#388E3C,stroke-width:1px

    subgraph IF_Simplified_POSO_ModelFDACL_e_g_SAP_HANA[" "]
        direction TB
        IF_Simplified_POSO_ModelFDAA_e_g_MES_300["e.g. MES 300"]:::appBox
        IF_Simplified_POSO_ModelFDAD_e_g_SAP_HANA[("🗄️ e.g. SAP HANA")]:::dbData
        IF_Simplified_POSO_ModelFDAA_e_g_MES_300 -.-> IF_Simplified_POSO_ModelFDAD_e_g_SAP_HANA
    end
    style IF_Simplified_POSO_ModelFDACL_e_g_SAP_HANA fill:#E3F2FD,stroke:#1976D2,stroke-width:1px
...
flowchart TB
    ...
    subgraph IF_Simplified_POSO_ModelCT_Boundary_Applications["Boundary Applications"]
        subgraph IF_Simplified_POSO_ModelCLN_Boundary_Applications[" ⬛ Boundary Applications"]
            direction LR
    ...
    style IF_Simplified_POSO_ModelCT_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:2px
    style IF_Simplified_POSO_ModelCLN_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:1px
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqdVm1vmzoU_isWUz7dpOUlJARVkXgxUyfSVpdtnTQm5ICTWHMAYVibdfnv1-C8UJqs7XUkYp9z_Dz28TnHfpLiLMGSKfV6TyQlpQmeQqlc4TUOJROE0hwx3uvzHsNxVZBy4-NfmAolzbK9tpnyFRUEzSlmtZrjLLK0DMjvHZQyyh-FcS330JrQjdAEeJlh8OW6DywOQPuAoZQNGC7IIpS2zQyaPcQrVJQ75IrhGXq8J0m5qiULRBmu7VblmvpojmmzhLKoGmnKtxjkKCbpshZrci0sUPqzLdS3W7Dt9cL0wAU-22EKeOv1wGDA1xavyAyVGGgXKvgHWL-rAgNWbigGMUWMYcbNxIxm7OIFmFeMpJgx0LQFodT84PFma31WFtlPzIcTy1D13XDwUO_JVPPHfpzRrDA_yLLcwUR5Do5NYDoO1D3vgCnLY8Md_gVTs0ZOBzZBJerC2rYLPfsAq-gj3ZGfwyotWHc4tpS9OkGMe7FAGxPoQO-QrUmSUPyAuAdbfoGyrR7I4EhXZPnsHmxPG8ndPeCMvnCN5zmue4R1RqqhGudhx4qjdGEZQqwLCxUbwvEBdmwrnqWehR1aytDowsY0q5L3e1zterwDm6V5gded-DDgyJkcYFU4drXzq1VsHao87AQwq-bLAuUrcO1FAVnnlCwITqK72-A2mvHUos7nyM6qNEHFJrJyro9RSbKUfQ-lvRy05aH0QyC_Dd2_OQsPwkqdK3PwOk3dElLguFYB_9_nmrPcEY6W0QwGkSbLnC-sEkNL-DfGI4AvlheA63hBkTmXaZo8M9-D-w1-CU6C1ooTiDhNxKDpiO5Zhtl9w9FUqSjAxS8S48iuWJswUcaCUNSynRXgVoL9mKWvkLmwIXMyVkaQ8qsgLaftjcVDwVMbgJ3B1by4nF6RqVAEX8EluHazmP99Cm5vri7JVCyirkuv7rZ9TrwKT_-EUoPrNkfOMa27a_71COW30Z_3e-1_OrteyhuCoN7eLtea6-S9ibYvSYanw2OSa4YBNedFkr-J6FzOvZ1JqZk6BcTHSx66z0I-kYEPP8Ib91m2ns5UP7Lu7roJ01rdiZTxo9l9N-Jnx6g-GeVingu7EezWFyRMS_4IakfmcQq89RsudZQMuWEyyBYDnyx2NPxuamXv8QyEU_aXlV7_Do6dTCYvvCr1pTUu1ogkkvkkHl78_ZbgBapoyZ9LEqrKLNiksWQ2DyCpyvlCsUsQP4S1EG7_A2XEM6o=" title="View full diagram">&#128065; View Diagram</a></div>
...
flowchart TB
    ...
    subgraph IF_Simplified_POSO_ModelFT_Boundary_Applications["Boundary Applications"]
        subgraph IF_Simplified_POSO_ModelFLN_Boundary_Applications[" ⬛ Boundary Applications"]
            direction LR
    ...
    style IF_Simplified_POSO_ModelFT_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:2px
    style IF_Simplified_POSO_ModelFLN_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:1px
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqdVm1vmzoU_isWUz7dpOUlJARVkXgxUyfSVpdtnTQm5GAnseYAwrA26_Lfr4G8UJqs7XUkYp9z_Dz28TnHfpLiFBPJlHq9J5rQwgRPoVSsyJqEkglCaY646PVFj5O4zGmx8ckvwholS9O9tp7yFeUUzRnhlVrgLNKkCOjvHZQyyh4b40ruoTVlm0YTkGVKwJfrPrAEAOsDjhI-4CSni1Da1jNY-hCvUF7skEtOZujxnuJiVUkWiHFS2a2KNfPRnLB6CUVe1tJEbDHIUEyTZSXW5EqYo-RnW6hvt2Db64XJgQt8tsMEiNbrgcFArC1e0RkqCNAuVPAPsH6XOQG82DACYoY4J1yYNTPqsUsWYF5ymhDOQd0WlDHzgyearfV5kac_iRhOLEPVd8PBQ7UnU80e-3HK0tz8IMtyBxNlGTi2BtNxoO55B0xZHhvu8C-YmjVyOrAYFagLa9su9OwDrKKPdEd-Dqu0YN3h2FL2aoy48GKONibQgd4hW1OMGXlAwoMtv0DZVg9kcKQrsnx2D7anjeTuHkjKXrjG8xzXPcI6I9VQjfOwY8VRurAcId6FhYoN4fgAO7YVz1LPwg4tZWh0YWOWlvj9Hle7Hu_ApkmWk3UnPgw4ciYHWBWOXe38ahVbh6oIuwaYl_NljrIVuPaigK4zRheU4OjuNriNZiK1mPc5stMywSjfRFYm9DEqaJrw76G0l4O2PJR-NMhvQ_dvzsKDsFTnyhy8TlM1THMSVyrg__tcc5Y7ItEymsEg0mRZ8IUlNjQsvjEZAXKxvABCJwqKLLhM0xSZ-R7cb_BLcBK0UpxAJAluBnWn6Z5lmN3XHHWVigKS_6IxieyStwmxMm4Im1q2swLCqmE_ZukrZC6syZyUFxFk4ipIiml7Y_Gw4akMwM7gap5fTq_otFEEX8EluHbTWPx9Cm5vri7ptFlEVZde3W37nEQVnv4JpRrXrY9cYFp31-LrUSZuoz_v99r_dHa1lDcEQbW9Xa7V18l7E21fkgxPh8ck1wwDas6LJH8T0bmcezuTUjF1CohPliJ0n4U8loEPP8Ib91m2ns5UP7Lu7roJ01rdiZTxo9l9N-Jnx6g-GeXNPBd2I9itLkiYFOIR1I7M4xR469dc6ggPhSEepIuBTxc7GnE3tbL3eAaNU_aXlV79Do6dTCYvvCr1pTXJ14hiyXxqHl7i_YbJApWsEM8lCZVFGmySWDLrB5BUZmKhxKVIHMK6EW7_A-i2M84=" title="View full diagram">&#128065; View Diagram</a></div>
...
flowchart TB
    ...
    style IF_Simplified_POSO_ModelCPLP_e_g_Azure_PaaS fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C
    ...
    style IF_Simplified_POSO_ModelCPLP_e_g_S_4_HANA_2023 fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20

    IF_Simplified_POSO_ModelCPLP_e_g_S_4_HANA_2023 ==>|"e.g. Direct / API / File"| IF_Simplified_POSO_ModelCPLP_e_g_Azure_PaaS

    subgraph IF_Simplified_POSO_ModelCPLLegend["📐 PLATFORM LEGEND"]
        direction LR
        IF_Simplified_POSO_ModelCPLLC["☁️ Cloud"]
        IF_Simplified_POSO_ModelCPLLS["🔮 SaaS"]
        IF_Simplified_POSO_ModelCPLLO["🏢 On-Prem"]
        IF_Simplified_POSO_ModelCPLLD["💾 Data Platform"]
        IF_Simplified_POSO_ModelCPLLM["🔗 Middleware"]
    end
    style IF_Simplified_POSO_ModelCPLLegend fill:#F5F5F5,stroke:#999,stroke-width:1px
    style IF_Simplified_POSO_ModelCPLLC fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C
    style IF_Simplified_POSO_ModelCPLLS fill:#E1BEE7,stroke:#7B1FA2,stroke-width:3px,color:#4A148C
    style IF_Simplified_POSO_ModelCPLLO fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20
    style IF_Simplified_POSO_ModelCPLLD fill:#B2EBF2,stroke:#00838F,stroke-width:3px,color:#004D40
    style IF_Simplified_POSO_ModelCPLLM fill:#FFE0B2,stroke:#E65100,stroke-width:3px,color:#BF360C
```
