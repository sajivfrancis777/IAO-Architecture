...
flowchart LR
    ...
    subgraph lane_0["  LE ++ Faulty Part"]
    ...
    subgraph lane_2["IMR Repair Plant "]
...
flowchart LR
    ...
    subgraph lane_1["IMR Repair Plant  (Different Plant)"]
    ...
    subgraph lane_2["LE ++ Faulty Part"]
...
flowchart LR
    ...
    subgraph lane_2["IMR Legal Entity (LE101)"]
    ...
    subgraph lane_4["Intel Product (Faulty Part)"]
...
flowchart LR
    ...
    subgraph lane_1["S/4 Intel Product "]
        n9[["fa:fa-cog Create Vendor Invoice"]]
    end
    subgraph lane_2["SAP CFIN Intel Foundry AR"]
...
flowchart LR
    ...
    classDef gateway fill:#FFF9C4,stroke:#F57F17,stroke-width:2px,color:#E65100
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["Inhouse Bank "]
        n1["Inhouse Bank"]
        n13{{"fa:fa-arrows-alt parallelGateway"}}
    end
    subgraph lane_1["Intel Foundry LE798"]
        n2["Create IP Customer Invoice"]
        n10[["fa:fa-cog Calculate Taxes"]]
    ...
    subgraph lane_3["SAP CFIN Intel Foundry AR"]
        n6[["fa:fa-cog Perform AR Posting"]]
        n7[["fa:fa-cog Perform Payment Receipt (Receiver)"]]
        n8[["fa:fa-cog Perform Cash Application"]]
        n12{{"fa:fa-arrows-alt parallelGateway"}}
    end
    subgraph lane_4["SAP CFIN Intel Product AP "]
        n3[["fa:fa-cog Perform Payment Receipt (Payer)"]]
        n4[["fa:fa-cog Perform AP Posting"]]
        n5[["fa:fa-cog Perform Payment Run (F110)"]]
    end
...
flowchart LR
    ...
    subgraph lane_4["IMR LE Malaysia"]
        n2["TM Embedded"]
    ...
    subgraph lane_5["IMR Legal Entity (LE101)"]
...
flowchart TD
    ...
    classDef gateway fill:#FFF9C4,stroke:#F57F17,stroke-width:2px,color:#E65100
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["SAP S/4 Intel Foundry IMR Legal Entity"]
...
flowchart LR
    ...
    subgraph lane_1["SAP S/4 Intel Foundry IMR Legal Entity"]
...
flowchart TB
    ...
    subgraph E2E110CDACL_e_g_Azure_SQL[" "]
        ...
        E2E110CDAD_e_g_Azure_SQL[("🗄️ e.g. Azure SQL")]:::dbCloud
        E2E110CDAA_e_g_XEUS -.-> E2E110CDAD_e_g_Azure_SQL
    end
    style E2E110CDACL_e_g_Azure_SQL fill:#E8F5E9,stroke:#388E3C,stroke-width:1px

    subgraph E2E110CDACL_e_g_SAP_HANA[" "]
        direction TB
        E2E110CDAA_e_g_MES_300["e.g. MES 300"]:::appBox
        E2E110CDAD_e_g_SAP_HANA[("🗄️ e.g. SAP HANA")]:::dbData
        E2E110CDAA_e_g_MES_300 -.-> E2E110CDAD_e_g_SAP_HANA
    end
    style E2E110CDACL_e_g_SAP_HANA fill:#E3F2FD,stroke:#1976D2,stroke-width:1px
...
flowchart TB
    ...
    subgraph E2E110FDACL_e_g_Azure_SQL[" "]
        ...
        E2E110FDAD_e_g_Azure_SQL[("🗄️ e.g. Azure SQL")]:::dbCloud
        E2E110FDAA_e_g_XEUS -.-> E2E110FDAD_e_g_Azure_SQL
    end
    style E2E110FDACL_e_g_Azure_SQL fill:#E8F5E9,stroke:#388E3C,stroke-width:1px

    subgraph E2E110FDACL_e_g_SAP_HANA[" "]
        direction TB
        E2E110FDAA_e_g_MES_300["e.g. MES 300"]:::appBox
        E2E110FDAD_e_g_SAP_HANA[("🗄️ e.g. SAP HANA")]:::dbData
        E2E110FDAA_e_g_MES_300 -.-> E2E110FDAD_e_g_SAP_HANA
    end
    style E2E110FDACL_e_g_SAP_HANA fill:#E3F2FD,stroke:#1976D2,stroke-width:1px
...
flowchart TB
    ...
    subgraph E2E110CT_Boundary_Applications["Boundary Applications"]
        subgraph E2E110CLN_Boundary_Applications[" ⬛ Boundary Applications"]
            direction LR
    ...
    style E2E110CT_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:2px
    style E2E110CLN_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:1px
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqVlnuPmzgQwL-KRZW_LtnlEQhBq0g8zGlPZLu6tN2Tygk54CRWHUAYuptu891rMEkIm_ThSMSeGf_GHsaDX6U4S7BkSYPBK0lJaYHXUCo3eItDyQKhtESM94a8x3BcFaTcBfgrpkJJs-ygbaZ8QgVBS4pZreacVZaWC_KtRSlG_iKMa7mPtoTuhGaB1xkGH--HwOYAOgQMpWzEcEFWobRvZtDsOd6gomzJFcNz9PJEknJTS1aIMlzbbcotDdAS02YJZVE10pRvcZGjmKTrWqzJtbBA6ZeuUN_vwX4wCNOjL_DBCVPA22AARiO-tnhD5qjEQLtRwV_A_lYVGLByRzGIKWIMM24mZjRjD6_AsmIkxYyBpq0IpdY7nzdHG7KyyL5gPpzapqq3w9FzvSdLzV-GcUazwnony3KPifIcnJpgui7Uff_IlOWJ6Y1_wtRsw-1hE1SiPtZxPOg7R6yiG7orn2OVDtYbT2zloE4Q41Es0M4COtB7zrYkSSh-RjyCnbhA2VGPzqChK7J8dQ-Orxlyfw84o29C4_uu552wrqGaqnkdO1FcpY9lCLE-FioOhJMjduIovq1exY5tZWz2sTHNquTPI672I97DZmle4G0vP0xouNMjVoUTT7u-WsXRocrTToBZtVwXKN8AqEJFkd0PkZNVaYKKXWTnOSUxKkmWss-hdJCDrjyU_hecS6zg4SoMhJW6VJbg19C6JaTAca0Cwb_nmtZThKN1NIeLSJNlTg-rxNQS_oyxAfDN-gZwHS8NMidblsXP2HXKf_Dj4iKiVlyYj9NEDJqO6La8-VNDbGpJtMDFVxLjyKlYF58oE4EXFae1AtxK-DqdpTO0Bxu0m7EygpSX57ScdRcdjwW1NgCtwd2yuJ3dkZlQLD6BW3DvZTH_-2fx_uHulsyEy7pW9HbSjS-vg7PvodRQvObFcIL9eM-fPqH8e_D9V_v_rSDVbt68mHpZbd42pfnnSXs4zKavw9Px0EwTau6b43EBey1_f5-r1NzeQQvwmqfKWYolMgjg3_DBO8v8y1kfRPbjYz9BO6u7kKJBNH_q59z8lFcX80zM82A_q7z6QwLTkl8WutlymgLfB40v1UjG3DAZZatRQFatG17DO6flFHERlENR1-vfMbDT6fRNVKWhtMXFFpFEsl7FBYXfcxK8QhUt-bVCQlWZLXZpLFnNRUGqcr5Q7BHEX8JWCPc_ADpb2JM=" title="View full diagram">&#128065; View Diagram</a></div>
...
flowchart TB
    ...
    subgraph E2E110FT_Boundary_Applications["Boundary Applications"]
        subgraph E2E110FLN_Boundary_Applications[" ⬛ Boundary Applications"]
            direction LR
    ...
    style E2E110FT_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:2px
    style E2E110FLN_Boundary_Applications fill:#E8F5E9,stroke:#388E3C,stroke-width:1px
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqVlnuPmzgQwL-KRZW_LtnlEQhBq0g8zGlPZLu6tN2Tygk54CRWHUAYuptu891rMEkIm_ThSMSeGf_GHsaDX6U4S7BkSYPBK0lJaYHXUCo3eItDyQKhtESM94a8x3BcFaTcBfgrpkJJs-ygbaZ8QgVBS4pZreacVZaWC_KtRSlG_iKMa7mPtoTuhGaB1xkGH--HwOYAOgQMpWzEcEFWobRvZtDsOd6gomzJFcNz9PJEknJTS1aIMlzbbcotDdAS02YJZVE10pRvcZGjmKTrWqzJtbBA6ZeuUN_vwX4wCNOjL_DBCVPA22AARiO-tnhD5qjEQLtRwV_A_lYVGLByRzGIKWIMM24mZjRjD6_AsmIkxYyBpq0IpdY7nzdHG7KyyL5gPpzapqq3w9FzvSdLzV-GcUazwnony3KPifIcnJpgui7Uff_IlOWJ6Y1_wtRsw-1hE1SiPtZxPOg7R6yiG7orn2OVDtYbT2zloE4Q41Es0M4COtB7zrYkSSh-RjyCnbhA2VGPzqChK7J8dQ-Orxlyfw84o29C4_uu552wrqGaqnkdO1FcpY9lCLE-FioOhJMjduIovq1exY5tZWz2sTHNquTPI672I97DZmle4G0vP0xouNMjVoUTT7u-WsXRocrTToBZtVwXKN8AqEJFkf0PkZNVaYKKXWTnOSUxKkmWss-hdJCDrjyU_hecS6zg4SoMhJW6VJbg19C6JaTAca0Cwb_nmtZThKN1NIeLSJNlTg-rxNQS_oyxAfDN-gZwHS8NMidblsXP2HXKf_Dj4iKiVlyYj9NEDJqO6La8-VNDbGpJtMDFVxLjyKlYF58oE4EXFae1AtxK-DqdpTO0Bxu0m7EygpSX57ScdRcdjwW1NgCtwd2yuJ3dkZlQLD6BW3DvZTH_-2fx_uHulsyEy7pW9HbSjS-vg7PvodRQvObFcIL9eM-fPqH8e_D9V_v_rSDVbt68mHpZbd42pfnnSXs4zKavw9Px0EwTau6b43EBey1_f5-r1NzeQQvwmqfKWYolMgjg3_DBO8v8y1kfRPbjYz9BO6u7kKJBNH_q59z8lFcX80zM82A_q7z6QwLTkl8WutlymgLfB40v1UjG3DAZZatRQFatG17DO6flFHERlENR1-vfMbDT6fRNVKWhtMXFFpFEsl7FBYXfcxK8QhUt-bVCQlWZLXZpLFnNRUGqcr5Q7BHEX8JWCPc_AK9h2Lc=" title="View full diagram">&#128065; View Diagram</a></div>
...
flowchart TB
    ...
    style E2E110FPLP_e_g_Azure_PaaS fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C

    subgraph E2E110FPLP_e_g_S_4_HANA_2023["🖥️ e.g. S/4 HANA 2023"]
        direction LR
        E2E110FPLA_e_g_MES_300["e.g. MES 300"]:::appBox
    end
    style E2E110FPLP_e_g_S_4_HANA_2023 fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20

    E2E110FPLP_e_g_S_4_HANA_2023 ==>|"e.g. Direct / API / File"| E2E110FPLP_e_g_Azure_PaaS

    subgraph E2E110FPLLegend["📐 PLATFORM LEGEND"]
        direction LR
        E2E110FPLLC["☁️ Cloud"]
        E2E110FPLLS["🔮 SaaS"]
        E2E110FPLLO["🏢 On-Prem"]
        E2E110FPLLD["💾 Data Platform"]
        E2E110FPLLM["🔗 Middleware"]
    end
    style E2E110FPLLegend fill:#F5F5F5,stroke:#999,stroke-width:1px
    style E2E110FPLLC fill:#BBDEFB,stroke:#0078D4,stroke-width:3px,color:#003A6C
    style E2E110FPLLS fill:#E1BEE7,stroke:#7B1FA2,stroke-width:3px,color:#4A148C
    style E2E110FPLLO fill:#C8E6C9,stroke:#2E7D32,stroke-width:3px,color:#1B5E20
    style E2E110FPLLD fill:#B2EBF2,stroke:#00838F,stroke-width:3px,color:#004D40
    style E2E110FPLLM fill:#FFE0B2,stroke:#E65100,stroke-width:3px,color:#BF360C
```
