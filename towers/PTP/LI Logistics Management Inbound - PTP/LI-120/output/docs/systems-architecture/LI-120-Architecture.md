<div style="text-align:center; padding-top:20px;">
  ...
  Capability LI-120 · LI Logistics Management Inbound - PTP</p>
...
<div class="page-footer"><span>Page 1</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
...
<div class="page-footer"><span>Page 2</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 3</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 4</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 5</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 6</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
flowchart TD
    ...
    subgraph Master Data Specialist
        n1["fa:fa-user Determine Type of Commodity"]
        n2["fa:fa-user Maintain Data for Inventory Commodity"]
        n3["fa:fa-user Maintain Data for Non-Inventory Commodity"]
        n4["fa:fa-user Categorize as Indirect Procurement"]
        n5["fa:fa-user Categorize as Stock Movement using ISM"]
        n6["fa:fa-user Categorize as Procurement for Major Tools and CSI"]
        n7(["fa:fa-play Collect Requirements for Commodities"])
        n8["Create and Process Purchase Order"]
        n9["Create PO Manually With ’Text Materials’"]
        n10["Create and Process Purchase Order"]
        n11["Create Transfer posting for Plant-to-Plant Transfer (IP)"]
        n12{{"fa:fa-code-branch Type ?"}}
        n13{{"fa:fa-code-branch Category?"}}
    end
    n7 --> n1
    n1 --> n12
    n3 --> n13
    n12 -->|"Inventory"| n2
    n2 --> n8
    n12 -->|"Non-Inventory"| n3
    n13 -->|"Indirect Procurement"| n4
    n4 --> n9
    n6 --> n10
    n5 --> n11
    n13 -->|"Stock Movement"| n5
    n13 -->|"Major Tools and CSI"| n6
    class n1 userTask
    class n2 userTask
    class n3 userTask
    class n4 userTask
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/edit#pako:eNqlVluP4jYU_itWRiN2pSDlSpg8tGICkZBKd1TY3YfSB5M44I6xqe0wQ1n-e4-TcAmFXVWNBIo_f-c7lxyfZG9lIidWbD0-7imnOkb7jl6RNenEqLPAinRsVANfsKR4wYjqGE4huJ7SvyuaG2zeDc1gKV5TtjPolCwFQZ_HNhqAIbORwlx1FZG06NidjaRrLHeJYEIa9gPpF05ReWu2noXMiTwTHCdysxBMGeXkDPtREAWpsVMkEzxviRZh0S-yzsEEx8RbtsJSV-GXikzw-1ea6xWsC8wUAc5Kr9kveEGYyVHL0mBZKbfHYlBl_HAo2HSDM8qXgAcOQBLz1zMUOocDOjw-zvnJKZoN5xzBlTGs1JAUSGmAR1uNCspY_BAkgzR0bKWleCXxgzeKhr5nZyaTGFJ3bFPc7huhy5WOF4LlDbX7ZnKIvc27Ld9jz7HlDv6vfBGenz0lPa_v9U-eniM3cZOjp6Io_pcnqKucYfXa-Br5qZcOT77csBcmzr_1jmkOg2jgXteJyC3NyIVomqb-6FyqUS90nfuiz6nfc5Ir0SXW5A3vzoJPSXASTMModaO7grW_6yjLxYsU2VHQH4VpeBKMnt104N0VDAZu0G8iBJ2lxJsVmmCliURDrDGabkgGJ4gqXZPMxd3f51aB4wJ3Tc3RkAB9DScDzXYbgkSBErFei5zq3dz648LOa9tNMOUafrWnQkg05lvCtZC7ewr-jxR-Fbz7Q5WgrZLAE1kKCRMFYQUx5FSSTCNT1FLC9OG6bR5-z3yqRfaKJmJbGUJTwrlE4-mkLdH7nsSF4yqnCf4T_mdCMIUwz1EyHbfVog8nuQ3DJm3GTAa_kb9KWgupSulYD0oUKHy8kOiDQiIJxFG5MCEQBaGUEmaIIuiTGYhtr09nk5dPECQvMWM79JXqFZqXnuM-zci7hg3oDmghVWNtDdf5735d92wzg-mnCqjgRihtKm2yfGEYpogW3ermzPkwfvl4JeXt98fKmXdRdwHcbFX38c9z63C4JPu3yc3D213wYejVNzxC3e5PYNss3WbpNWu_WfvHfc8A3-bWqYfn1jc4OM22V9P71-xW11cWJ0H_JHirrYEZNMyg1n5qlr0msmba8LBZu9fC7YavJMNrzs0OBmLvYpSZ4hxHeAv2bsP-bTi4DYe34d5tODq9Iltw_zb8dBt2nTu4ewf3ju-GNuwfYcu21jBoMc2teG9VH0bw8ZSTApdMWwfbwqUW0x3PrLj6gLDKTQ6WQ4phrq9r8PAP6_gEUg==" title="Edit in Mermaid Live">&#9998; Edit in Mermaid Live</a></div>
...
flowchart LR
    ...
    subgraph Transportation Manager (Transportation Management)
        n1[["fa:fa-cog Create Freight Unit"]]
        n2[["fa:fa-cog Create/ Release Freight Order"]]
    end
    subgraph Warehouse Operator
        n3[["fa:fa-cog Create Inbound Delivery"]]
        n4[["fa:fa-cog Monitor Inbound Shipments"]]
        n5[["fa:fa-cog Receive ASN Information from Middleware"]]
        n6["Intake / Accept Physical Goods to unload Dock"]
        n7["Validate Physical Documents"]
        n8["Validate BOL against IBD"]
        n9["Unload Material Received"]
        n10{{"fa:fa-code-branch Intel Managed TM?"}}
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/edit#pako:eNqlVVtv4jgU_itWqopdKWhyJTQPu-KWUaUyHZV2RqthHkxyQqwaO3KcFobhv69NLkC2PG0ekM53zvedC8f23oh5AkZo3N7uCSMyRPuezGADvRD1VriAnokq4BsWBK8oFD0dk3ImF-TXMcz28q0O01iEN4TuNLqANQf0cm-ikSJSExWYFf0CBEl7Zi8XZIPFbsIpFzr6BoaplR6z1a4xFwmIU4BlBXbsKyolDE6wG3iBF2leATFnyYVo6qfDNO4ddHGUv8cZFvJYflnAHG-_k0Rmyk4xLUDFZHJDH_AKqO5RilJjcSnemmGQQudhamCLHMeErRXuWQoSmL2eIN86HNDh9nbJ2qTo4WnJkPpiiotiCikqpIJnbxKlhNLwxpuMIt8yCyn4K4Q3ziyYuo4Z605C1bpl6uH234GsMxmuOE3q0P677iF08q0ptqFjmWKnfju5gCWnTJOBM3SGbaZxYE_sSZMpTdP_lUnNVTzj4rXONXMjJ5q2uWx_4E-s_-o1bU69YGR35wTijcRwJhpFkTs7jWo28G3ruug4cgfWpCO6xhLe8e4keDfxWsHIDyI7uCpY5etWWa6-Ch43gu7Mj_xWMBjb0ci5KuiNbG9YV6h01gLnGXpWK1XkXEgsCWdojhleg0B_fIhvgMk_KwH9MfvHj6WR4jDF_Ziv0USA6hdF4vifohd1zJfGz59nBOcjwif0BBTUFdAyH_WJPFHVWnWq_o4FZFwtAXrMQWDJxVkS98Oq7tmKlyxBU6DkDcSuU5l3SZpzVTwXLWuRkVx3X3Ro_iXtCWJQ6mi0-KKoKRebanyp4Bs0J0lC1ToI6IgMlMY9k_gV0Cc0imPIJfqa7QoSY4o-c54USHJUMsqxqp_Hr4p_Rg8U_RumJNFttjwVVzYVnwUPz4PHjw8IrzFhhUT34-ll5J2KfKlyzlWwvlub_pLLSNva709TSKC_UssTZ2oCEmi9Ogl6nv-9NA6Hc579MQ-2MS0LledzdXxOtHYTmIv6_b906tq2K9upzUFlBrUZVOawNv2abDfkmu3W9rAy72rT6YR7lT1o2Ja2fy-Nf0AN-7cCuo4v_Ih7Z4dZV3x25Vx4nKse96rHu-rxr3ru2sfhsjCrubcuYbuBDdPYgFptkhjh3jg-2uphTyDFJZXGwTRwKflix2IjPD5uRpnrdZsSrE7vpgIP_wLYO44d" title="Edit in Mermaid Live">&#9998; Edit in Mermaid Live</a></div>
...
flowchart TD
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph Warehouse Operator
        n1[["fa:fa-cog Return Goods to Supplier"]]
        n2[["fa:fa-cog Scrap Goods"]]
        n3["Perform Physical Inspection"]
        n4["Accept Goods"]
        n5["Reject Goods"]
        n6(["fa:fa-stop Goods Returned"])
        n7(["fa:fa-stop Goods Scrapped"])
        n8["Receive Material Against Advanced Shipping Notification (ASN)"]
        n9["Unload Material Received"]
        n10{{"fa:fa-code-branch Accept or Reject?"}}
        n11{{"fa:fa-code-branch Return or Scrap?"}}
    end
    n9 --> n3
    n3 --> n10
    n4 --> n8
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/edit#pako:eNqlVV2P2jgU_StWRiNaKUhJSAiTh11lgKwqbbuj0m4fSh-Mc0O8E-zIdphhKf997cRAoMzT8oC455x77kews3cIz8FJnPv7PWVUJWg_UCVsYJCgwQpLGLioA_7GguJVBXJgNAVnakH_bWV-WL8amcEyvKHVzqALWHNAXz-4KNWJlYskZnIoQdBi4A5qQTdY7Ka84sKo72BSeEVbzVKPXOQgzgLPi30S6dSKMjjDoziMw8zkSSCc5RemRVRMCjI4mOYq_kJKLFTbfiPhI379RnNV6rjAlQStKdWm-hOvoDIzKtEYjDRie1wGlaYO0wtb1JhQttZ46GlIYPZ8hiLvcECH-_slOxVFX2ZLhvSHVFjKGRRIKg3PtwoVtKqSu3CaZpHnSiX4MyR3wTyejQKXmEkSPbrnmuUOX4CuS5WseJVb6fDFzJAE9asrXpPAc8VOf1_VApafK03HwSSYnCo9xv7Unx4rFUXxvyrpvYovWD7bWvNRFmSzUy0_GkdT71e_45izME796z2B2FICPdMsy0bz86rm48j33jZ9zEZjb3plusYKXvDubPgwDU-GWRRnfvymYVfvustm9SQ4ORqO5lEWnQzjRz9LgzcNw9QPJ7ZD7bMWuC7RNyyg5Hqd6K8aBFZcdALzYf7370unwEmBh4Sv0WdQjWDoD85ziRRHi6auKwpi6fz40csKLrMWRBfqkq6EI617AlFwsUFP5U5Sgiv0gckaiKKcaXVPHGpxSgjU6uTVYyPNfoZ_dOItdvzu1JFU3DZjx4Fca9_3xPFNcTtF_Yt40tYlQLeAPuqHbW4glK4xZVKhNN9iRiBHi5LWtT6z6BNXtNBjmvHQu3Tx6f1low_a7iurOM7PbtY-v1T63n5_3nIOw5W-G0iJ7Iq4QN06fl86h0M_z7-dZ5-tzmsn7aXpQ939YA9oOPxNPzYbjrrQt_9RFnbxxIaRpe1BY34Xj20YdGF8ZD0T_zw-46XzUxtec91ILRcdOd9ybdstFVxT3Wwt1z_1pqXeqb9ggjeZsb3lLsD4Fjg53b0X8MNtWA9pb4tL2D_CjutsQGwwzZ1k77SvSv06zaHATaWcg-vgRvHFjhEnaV8pTlPnOnNGsT7pmw48_AeSbF5a" title="Edit in Mermaid Live">&#9998; Edit in Mermaid Live</a></div>
...
flowchart LR
    ...
    subgraph Receiving Agent
        ...
        n2["Move Inventory to Block Stock"]
        n3["Complete Goods Receipt into Warehouse Dock"]
        n4["Instruct to Receive Inventory into Block Stock"]
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/edit#pako:eNqlVV2PozYU_SsWo1F2JaICgZDhoVW-qEbamVZLt6Oq6YNj7MQasJExmaTZ_Pde85EPduapPCDd43PPuffamKNFZEqtyLq_P3LBdYSOA72lOR1EaLDGJR3YqAH-xIrjdUbLgeEwKXTC_61prl_sDc1gMc55djBoQjeSom-PNppCYmajEotyWFLF2cAeFIrnWB3mMpPKsO_ohDmsdmuXZlKlVF0IjhO6JIDUjAt6gUehH_qxySspkSK9EWUBmzAyOJniMvlGtljpuvyqpE94_8JTvYWY4aykwNnqPPuC1zQzPWpVGYxUatcNg5fGR8DAkgITLjaA-w5ACovXCxQ4pxM63d-vxNkUffm6EggekuGyXFCGSg3wcqcR41kW3fnzaRw4dqmVfKXRnbcMFyPPJqaTCFp3bDPc4Rvlm62O1jJLW-rwzfQQecXeVvvIc2x1gHfPi4r04jQfexNvcnaahe7cnXdOjLH_5QRzVX_g8rX1Wo5iL16cvdxgHMydH_W6Nhd-OHX7c6Jqxwm9Eo3jeLS8jGo5DlznY9FZPBo7857oBmv6hg8XwYe5fxaMgzB2ww8FG79-ldX6dyVJJzhaBnFwFgxnbjz1PhT0p64_aSsEnY3CxRZ9pYTyHZwnNN1QoZtV8wj375X1KMqCEo2eoA_zcZWISYUWOMcburL-uWJ7wH6SO4oexQ50pDogLdEsk-QVJRret_QR0OcyLzKqKfpVyrRsKik04pCNXrCiWwm7jBY_5PpNYfDdQGXAbVq4dq4lPvQOP4EAwxHDw1LLom0nvcqvU2kKaZ-v8iaQ1nl1A4GpYQ61oGm6w4KASrLlRWHm-Sw1Z5xgzaVAn6bJ8-fbMh5qOV0pcVGDspOqKDJO1S3ZdYD9TWQSpxd2W0zao7rHY9efuXOHa7g1yBY9lgjuVwTHJzWD67r-ZWWdTtfp3vvpyz2hhenlJ_SiJPT3qGmOEpjYlQJcAL3zddnI3wqqMIz3yiuodxKOVI6ma1npXnHlbWNjw07BkLND3UoiK0Uokqx_Is9lCB8Nhz_DcWvDURN6beg6Tex2sWvi7yvrWa6s77DjLR40tHEbek0YdlmtyFnVu1Vx3f7CX6Y1WHno-3YLQbswbqT9q1sAfNt79gacnC_6G_jhfRgafx93uyvrFvY62LKtnKoc89SKjlb9v4Z_ekoZrjJtnWwLV1omB0GsqP6vWVWRQuaCYzgOeQOe_gNcIIqT" title="Edit in Mermaid Live">&#9998; Edit in Mermaid Live</a></div>
...
flowchart TD
    ...
    subgraph Warehouse Clerk
        n1[["fa:fa-cog File Shipping Claim"]]
        n2["Receive Material Against Advanced Shipping Notification (ASN)"]
        n3["Process Damaged Goods"]
    end
    n3 --> n1
    n1 --> n2
    class n1 serviceTask
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/edit#pako:eNqlVMuOmzAU_RWLUUQrEYlnSFlUIiRUldpR1Uw7i8ksHGODFWNHtvNqlH-vnQfJpJpVWSB8fO459x4weweJCjuZ0-vtKac6A3tXN7jFbgbcOVTY9cAJ-A0lhXOGlWs5RHA9pX-OtCBebi3NYiVsKdtZdIprgcGvrx7ITSHzgIJc9RWWlLieu5S0hXJXCCakZT_gIfHJ0e28NRKywvJK8P00QIkpZZTjKxylcRqXtk5hJHj1RpQkZEiQe7DNMbFBDZT62P5K4e9w-0wr3Zg1gUxhw2l0y77BOWZ2Ri1XFkMrub6EQZX14Saw6RIiymuDx76BJOSLK5T4hwM49Hoz3pmCp_GMA3MhBpUaYwKUNvBkrQGhjGUPcZGXie8pLcUCZw_hJB1HoYfsJJkZ3fdsuP0NpnWjs7lg1Zna39gZsnC59eQ2C31P7sz9zgvz6upUDMJhOOycRmlQBMXFiRDyX04mV_kE1eLsNYnKsBx3XkEySAr_X73LmOM4zYP7nLBcU4RvRMuyjCbXqCaDJPDfFx2V0cAv7kRrqPEG7q6Cn4q4EyyTtAzSdwVPfvddruY_pEAXwWiSlEknmI6CMg_fFYzzIB6eOzQ6tYTLBjxDiRth4gQFw3Jx2rUXD15eZg6BGYF9JGpQUobBtKHLpfn4DBnSdua8vt4UhIb_EyNM1xh8N4Pb0wjyGlKuNMirNeQIV1eJR6EpoQhqKjj4kE8fPxq9G7nIyNlZsVJgDFtYm-IvQlSqo5nP7fTAI9DvfzYtn5fBaRnehGfBm1f8ZifsDskbOOpgx3NaLFtIKyfbO8e_lPmTVZjAFdPOwXPgSovpjiMnO55mZ7WsTABjCk3I7Qk8_AUBBZyJ" title="Edit in Mermaid Live">&#9998; Edit in Mermaid Live</a></div>
...
flowchart LR
    ...
    subgraph Inventory Manager
        n2(["fa:fa-play GR Data Updated"])
        n3(["fa:fa-stop ASN Data Sent to 3PL"])
        n4(["fa:fa-stop Physical Goods Sent to 3PL"])
        n5["Receive Material Against Advanced Shipping Notification (ASN)"]
        n7{{"fa:fa-code-branch exclusiveGateway"}}
        n8{{"fa:fa-code-branch IM or 3PL?"}}
        n9{{"fa:fa-code-branch exclusiveGateway"}}
        n10{{"fa:fa-arrows-alt parallelGateway"}}
    end
    subgraph Sender
        n1["Ship Physical Goods Against Delivery"]
        n6["Create Outbound Delivery"]
        n11{{"fa:fa-arrows-alt inclusiveGateway"}}
    end
    n6 --> n11
    n10 --> n3
    n7 --> n8
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/edit#pako:eNqlVU2P4jgQ_StWWi1mpCDlk0AOu6KBtFrqnm01OzOHYQ8mcYjVxo5s87UM_33LJIEmA3vYzSFSvbx6r6oc23srFRmxYuv-fk851THad3RBlqQTo84cK9KxUQV8w5LiOSOqYzi54HpK_z7S3KDcGprBErykbGfQKVkIgr4-2WgIicxGCnPVVUTSvGN3SkmXWO5Ggglp2Heknzv50a3-9CBkRuSZ4DiRm4aQyignZ9iPgihITJ4iqeDZhWge5v087RxMcUxs0gJLfSx_pcgL3n6nmS4gzjFTBDiFXrJnPCfM9KjlymDpSq6bYVBlfDgMbFrilPIF4IEDkMT8_QyFzuGADvf3M34yRc9vM47gSRlWakxypDTAk7VGOWUsvgtGwyR0bKWleCfxnTeJxr5np6aTGFp3bDPc7obQRaHjuWBZTe1uTA-xV25tuY09x5Y7eLe8CM_OTqOe1_f6J6eHyB25o8Ypz_P_5QRzlX9i9V57TfzES8YnLzfshSPnV72mzXEQDd32nIhc05R8EE2SxJ-cRzXpha5zW_Qh8XvOqCW6wJps8O4sOBgFJ8EkjBI3uilY-bWrXM1fpUgbQX8SJuFJMHpwk6F3UzAYukG_rhB0FhKXBXria8K1kDv0gjleEFl9Nw_3Pv2YWTmOc9wtGXTx-IbGWGP0tcygr2xm_fX5A9s_s5UWJRpOv1T0KRggLZD_-txKCVopr8VO0RQz9ChEpv4lMYS8N5ISuiZQtyZm46PhAlOuNBpma8xTkqFpQcsStgr6IjTNQVhTwdEnKOwz6H2Qi_b7pg5zSnXnsM_SApFtylYKPB6rZZxZh8OHrP71rKcXJKSp-fcWf_CfXFznnIalFBvVxUyjEkvMGGG_JMEebC0xjDG7WFcXpmdm0553M8AxYVCO3F0OqQdZI0nAD_2x0nOx4tkNputeLZnyW42eauY91O3-ZhTq2HUqwK_jqAr7rc9RE7t1fh33TfhzZsFqoO9YkkLAwTGzfsKv12LAql0SBjXBqxSbcFCFYdvQaYCLgo771mg0p_AF7NcH5gUYXAPD6wK963DUnDsXaP8qOriKwlyvwm4DW7a1JHKJaWbFe-t4b8PdnpEcr5i2DraFV1pMdzy14uP9Zq2OZ8aYYvgnlxV4-Ad1HIyW" title="Edit in Mermaid Live">&#9998; Edit in Mermaid Live</a></div>
...
flowchart TD
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph Inventory Manager
        n2[["fa:fa-cog Perform Goods Receipt for Free Samlples"]]
        n4["Perform Physical Inspection"]
        n9(["fa:fa-stop PGR Completed"])
    end
    subgraph Procurement Agent
        n1[["fa:fa-cog Create Purchase Orders for Free Samples"]]
        n5(["fa:fa-play Procurement Request Received"])
        n7(["fa:fa-stop Order Data is Sent"])
        n8(["fa:fa-stop Requirement Sent to Supplier"])
        n10{{"fa:fa-code-branch Procure with PO or Without PO?"}}
    end
    subgraph Receiving Agent
        n3["Note Physical Goods Arrival at Warehouse"]
        n6(["fa:fa-play Physical Goods Received"])
    end
    n2 --> n9
    n4 --> n2
    n3 --> n4
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/edit#pako:eNqlVVGPokgQ_isdJhPvEkwAQRwe7uKgbDa5vTXj3s3Dug8tFNoZoLnuRsdz_e9XLYji6NP5QKyvqr6vqrop9kbMEzAC4_FxzwqmArLvqTXk0AtIb0kl9ExSA39TwegyA9nTMSkv1Jz9ewyz3fJdh2ksojnLdhqdw4oD-euzScaYmJlE0kL2JQiW9sxeKVhOxS7kGRc6-gFGqZUe1RrXMxcJiHOAZfl27GFqxgo4wwPf9d1I50mIeZF0SFMvHaVx76CLy_g2XlOhjuVXEr7Q91eWqDXaKc0kYMxa5dkfdAmZ7lGJSmNxJTanYTCpdQoc2LykMStWiLsWQoIWb2fIsw4Hcnh8XBStKPk2WRQEf3FGpZxASqRCeLpRJGVZFjy44TjyLFMqwd8geHCm_mTgmLHuJMDWLVMPt78FtlqrYMmzpAntb3UPgVO-m-I9cCxT7PB5pQVFclYKh87IGbVKz74d2uFJKU3T_6WEcxXfqHxrtKaDyIkmrZbtDb3Q-sh3anPi-mP7ek4gNiyGC9IoigbT86imQ8-27pM-R4OhFV6RrqiCLd2dCZ9CtyWMPD-y_buEtd51ldVyJnh8IhxMvchrCf1nOxo7dwndse2OmgqRZyVouSafiw0Uiosd-UILugJR-_WvcL5_XxgpDVLaj_mKzECkXOTkE-eJJC8QAyvxsLkgkQAgc5pnJb62C-PHjwsSFzlOmbP1TrKYZqgqS4gV4wVGXwQ__dIqSsVLMvv0QkKeI62CBEN_rWPxnl21oYdSCdwehSLjFT4vSO1uG6EAPBUyqwS-MRLIV_36y04fN9rwzpWVGZ7opeAL_FOBVPVINpeFHlP9q6aOgmRCFSVMkrkutpswukrQ_KzR0uFEcTKvyjJjeFzdVNva78_NJtBf4sqI2_mQLVNofCXY7Cv-5ZVC6_eFcTjcm2zdFC6cD3MdYJV_cj3K07HWN2MsBNugRRV5pQJQREL3mIfXw-wSfJxjW1bhkH7_N7wojenWptOYg9p0G3NYm4PGtGvTb0yvNm3r5LY08HNhnCezMH7icdzyn5yXa0QrXKyRjse56_HaFd2Bh7dhv1myHXB0C3y6BWIPzU4yTCMHkVOWGMHeOH558eucQEqrTBkH06CV4vNdERvB8QtlVGWCmRNG8V7kNXj4D62_fdA=" title="Edit in Mermaid Live">&#9998; Edit in Mermaid Live</a></div>
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/edit#pako:eNqlVd-P2jgQ_lesrFbcSUFKQkJoHu4EgVSVrtLe0msfSh-MMwbfOnZkO-xylP_9bBIIS7vSSZeHKPPNzPfNTPzj4BFZgpd59_cHJpjJ0GFgtlDBIEODNdYw8FELfMaK4TUHPXAxVAqzZP-cwsK4fnFhDitwxfjeoUvYSEB_ffDR1CZyH2ks9FCDYnTgD2rFKqz2ueRSueg7mNCAntQ610yqElQfEARpSBKbypmAHh6lcRoXLk8DkaJ8RUoTOqFkcHTFcflMtliZU_mNho_45QsrzdbaFHMNNmZrKv4HXgN3PRrVOIw0anceBtNOR9iBLWtMmNhYPA4spLB46qEkOB7R8f5-JS6i6NN8JZB9CMdaz4EibSy82BlEGefZXZxPiyTwtVHyCbK7aJHOR5FPXCeZbT3w3XCHz8A2W5OtJS-70OGz6yGL6hdfvWRR4Ku9fd9ogSh7pXwcTaLJRWmWhnmYn5Uopf9Lyc5VfcL6qdNajIqomF-0wmSc5MGPfOc253E6DW_nBGrHCFyRFkUxWvSjWoyTMHibdFaMxkF-Q7rBBp7xvid8l8cXwiJJizB9k7DVu62yWT8oSc6Eo0VSJBfCdBYW0-hNwngaxpOuQsuzUbjeog9iB8JItUcfscAbUK3fPSL8-nXlUZxRPCRygx5AUakq9F7KUqNHIMBqg4xEMy7JE1oa-155375dMUT_geEmZWQzPmPOSjs69GeDhWFmjyRFD9u9ZgTzLnu6wUxog-aSNJVtoePbQWkJr_jiXy4l1Nz-ilsapVwOwgZ9wQq20q4sS_DrFUPSM2gj67bRtumT2HXs-Cb2_SPKZVVzMD-EpodDP5sShmu7ucm2b7kbApPCKmLT6N9X3vHYEtiN1n6IGA2Hv9mpdeaoNdPODFsz6cyoNcedmTrz-8p7hL-BnAr8blNunFNCoD47o6vl6NivNs0rT_SmJ74cSK_gpDs7XoHjn4HpeVN5vleBqjArvezgna4Oe72UQHHDjXf0PdwYudwL4mWnI9Zrarem5gzblV-14PFff8UboQ==" title="Edit in Mermaid Live">&#9998; Edit in Mermaid Live</a></div>
...
flowchart TD
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph Supplier
        n1["Confirm Disposition"]
        n2(["fa:fa-play Receive Exemption Report"])
        n3(["fa:fa-stop Send Disposition Report"])
    end
    n2 --> n1
    n1 --> n3
    class n2 startEvt
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/edit#pako:eNqlVMuq2zAU_BXhS3ALDvgZp14UEjuGQguluW0XTReKfZSIK0tGkvNoyL9Xysu5KXdVL4w1njNzzljWwalEDU7mDAYHyqnO0MHVa2jAzZC7xApcD52BH1hSvGSgXMshgus5_XOiBXG7szSLlbihbG_ROawEoO-fPDQxhcxDCnM1VCApcT23lbTBcp8LJqRlP8GY-OTkdnk1FbIG2RN8Pw2qxJQyyqGHozRO49LWKagEr1-JkoSMSeUebXNMbKs1lvrUfqfgC979pLVemzXBTIHhrHXDPuMlMDujlp3Fqk5urmFQZX24CWze4orylcFj30AS85ceSvzjER0HgwW_maLnYsGRuSqGlSqAIKUNPNtoRChj2VOcT8rE95SW4gWyp3CWFlHoVXaSzIzuezbc4Rboaq2zpWD1hTrc2hmysN15cpeFvif35v7gBbzunfJROA7HN6dpGuRBfnUihPyXk8lVPmP1cvGaRWVYFjevIBkluf-v3nXMIk4nwWNOIDe0gjvRsiyjWR_VbJQE_tui0zIa-fmD6Apr2OJ9L_ghj2-CZZKWQfqm4Nnvsctu-VWK6ioYzZIyuQmm06CchG8KxpMgHl86NDorids1mndtyyjIM2wvHvxaOLnghMoGFVS1QlFNBV84v-9I4TvDIjgjeNgyM-E3qIBuAM120LSWbpBWSG2q3t-VRX2Z0qJFc7Nl7k3-qTLvzw88RMPhR9PdZRmcl9FdQJZz3e6v4OiyMx3PaUA2mNZOdnBOp405kWoguGPaOXoO7rSY73nlZKe_0una2nzBgmITVnMGj38BZvyJpg==" title="Edit in Mermaid Live">&#9998; Edit in Mermaid Live</a></div>
...
flowchart TD
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph Inventory Manager
        n1["fa:fa-user - 200-010 Perform Goods Receipt"]
        n2["fa:fa-user - 200-040 Perform Goods Receipt to Block Stock"]
        n3["- 200-030 Reload Shipment"]
        n4["- 200-020 Move Material to Holding Location"]
        n5["- 200-050 Move Material to Holding Location"]
        n6["- 200-070 Reload Shipment"]
        n7(["fa:fa-stop GR Completed"])
        n8(["fa:fa-stop Initiate Return to Vendor Process"])
        n9(["fa:fa-stop Initiate Return to Vendor Process"])
        ...
        n15[["fa:fa-folder-open - 200-060 LI-200-010 Determine Material Disposition"]]
    end
    n3 --> n8
    n1 --> n7
    n4 --> n3
    ...
    n14 --> n12
    n12 -->|"Fail"| n13
    n13 -->|"Correct Material"| n2
    n5 --> n15
    n15 --> n6
    n12 -->|"Pass"| n1
    n13 -->|"Incorrect Material"| n4
    class n1 userTask
    class n2 userTask
    class n7 endEvt
    class n8 endEvt
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/edit#pako:eNqlVltvozgU_isWVZUZCSSuIeVhVy0J3Uit1J3M5WGyDw6YxCrYyHbSZjL573scIBQm1Wo1PCDOx_m-c_Ex5mCkPCNGZFxfHyijKkKHkdqQkowiNFphSUYmqoGvWFC8KogcaZ-cM7WgP05ujl-9ajeNJbikxV6jC7LmBH2Zm-gWiIWJJGbSkkTQfGSOKkFLLPYxL7jQ3ldkktv5KVrz6o6LjIjOwbZDJw2AWlBGOtgL_dBPNE-SlLOsJ5oH-SRPR0edXMFf0g0W6pT-VpJH_PqNZmoDdo4LScBno8riAa9IoWtUYquxdCt2bTOo1HEYNGxR4ZSyNeC-DZDA7LmDAvt4RMfr6yU7B0Wfp0uG4EoLLOWU5EgqgGc7hXJaFNGVH98mgW1KJfgzia7cWTj1XDPVlURQum3q5lovhK43KlrxImtcrRddQ-RWr6Z4jVzbFHu4D2IRlnWR4rE7cSfnSHehEztxGynP89-KBH0Vn7F8bmLNvMRNpudYTjAOYvtXvbbMqR_eOsM-EbGjKXkjmiSJN-taNRsHjv2-6F3ije14ILrGirzgfSd4E_tnwSQIEyd8V7CON8xyu3oSPG0FvVmQBGfB8M5Jbt13Bf1bx580GYLOWuBqg-ZsR5jiYo8eMcNrIur3-mLO96WR4yjHlm43spBr25bt2OiJiJyLEt1znkn0iaSEVmpp_POG617k-u9wkeLoruDpM1oouPelPJBq-J4NjILjDC02tCoh876r37m6NnrkOwJlKaK_CzrEXzBlsHXQA0-xopz1yUFHDv43edyRw_9IMvxw7o1UvEL3n1DMy6ogimTg-fGN62TgOocvJ4WcIIDaCqbT-gqbjgukp4JIOeDf_CbfsYE_Z7IiqeqaAeuHpriEaUEfngQFC3SalfzYr9XRMxRvCKxsjw7hKhiLv7eYKar2A5J7OLRp61PDWsF3L92cvRFmmTYK_VyLLxRWW_nn0jge3wp5l4XmEsFR02UUcyF0hZDYnKW18YuWf1mLvKbFVtIdua_3-pAWfD8vQQ4TRIQFlbN2Q4xt9DC32n01hREQJRw7XWpTKisuaTNwTZdgyeoH5iHL-gPmpDGd2gwb069NrzHd2gwac1ybNy3Xrm3HbwFnCDR6jtsCJ8WfSyPBtFgaP3XH21de86rtbVvRya0VCBrBNiWnAcbDAE9Yz6YOMNQ_L1g_gv_mw6n70h4YPdi9DIfNQdYDJ5fAm0sgNLI9dPu48w7utudEH_Yuw_5lOGjPBsM0SpgiTDMjOhinXyr47cpIjreFMo6mgbeKL_YsNaLTr4exrTIQnFIMJ0JZg8d_AfgKAqo=" title="Edit in Mermaid Live">&#9998; Edit in Mermaid Live</a></div>
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/edit#pako:eNqlVNuO0zAQ_RUrq1VBSqVcNyUPoG7aICQuZXcBIcqD64wba107sp12S-m_Y_fewj6RhyhzfOacmYntlUdkBV7uXV-vmGAmR6uOqWEGnRx1JlhDx0db4CtWDE846I7jUCnMPfu1oYVJ8-RoDivxjPGlQ-9hKgF9eeejvk3kPtJY6K4GxWjH7zSKzbBaFpJL5dhX0KMB3bjtlm6lqkAdCUGQhSS1qZwJOMJxlmRJ6fI0ECmqM1Ga0h4lnbUrjssFqbEym_JbDR_w0zdWmdrGFHMNllObGX-PJ8Bdj0a1DiOtmu-HwbTzEXZg9w0mTEwtngQWUlg8HqE0WK_R-vp6LA6m6GEwFsg-hGOtB0CRNhYezg2ijPP8Kin6ZRr42ij5CPlVNMwGceQT10luWw98N9zuAti0NvlE8mpH7S5cD3nUPPnqKY8CXy3t-8ILRHV0Km6iXtQ7ON1mYREWeydK6X852bmqB6wfd17DuIzKwcErTG_SIvhbb9_mIMn64eWcQM0ZgRPRsizj4XFUw5s0DJ4XvS3jm6C4EJ1iAwu8PAq-KpKDYJlmZZg9K7j1u6yynYyUJHvBeJiW6UEwuw3LfvSsYNIPk96uQqszVbip0TsxB2GkWqIPWOApqO26e0T4Y-xRnFPcdeNGI6kNeitlpdEdEGCNGXs_T-jRiwNfG9mgt3eokLOGg4EKUalQn5gWc_S5xcIws7TZL0_SY5t9B1ryOaAB00RBgwVhoFEXjR5G516JJRc1kEdbtgF37jcOdjaNrfTE4SQnXa329bm7qDuxp4nUu472KU7PggtmajT69GbsrddbCbu3tx8iQd3uayu3C8NtGO3C1IW_x9530GPvt12-wD_KDRyf_Finsd_QZ3C0O1FnYHw40mdw8m843e9Bz_dmoGaYVV6-8jY3rb2NK6C45cZb-x5ujbxfCuLlmxvJa5vKZg4YthtltgXXfwDG-Nj6" title="Edit in Mermaid Live">&#9998; Edit in Mermaid Live</a></div>
...
<div class="page-footer"><span>Page 14</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 15</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 16</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 17</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 18</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 19</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 20</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
<div class="page-footer"><span>Page 21</span><span><a href="#toc">↑ Back to TOC</a></span><span>LI-120 — Receive Materials and Services - PTP</span></div>
<div style="page-break-before: always;"></div>
...
---
*LI-120 — Architecture Document (TOGAF BDAT) · Procure To Pay · Generated: March 2026*
