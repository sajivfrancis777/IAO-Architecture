<div style="text-align:center; padding-top:20px;">
  ...
  Capability QI-130 · QI Quality Management (Incoming)</p>
...
| **Process Group** | QI Quality Management (Incoming) |
| **Capability** | QI-130 - Perform Incoming Quality Assurance |
| **Release** | R1 – R5 |
| **Total Systems** | 0 |
...
| **L1 Process** | QI Quality Management (Incoming) |
| **L2 Capability** | QI-130 - Perform Incoming Quality Assurance |
...
| QI-130 Migration Completeness | 100% flow chains validated | All 0 flow chains verified in target state | 0% (pre-migration) | Tower Architect |
...
This capability includes **4 business process(es)** modeled in BPMN 2.0, covering the end-to-end workflow for QI-130 Perform Incoming Quality Assurance.

| # | Step ID | Process Name | Lanes | Tasks | Gateways |
|---|---------|--------------|-------|-------|----------|
| 1 | QI-130-040_Document_Results | QI-130-040_Document_Results | Quality Analyst, Quality Engineer (Extended Production Operations), Quality Manager | 5 | 2 |
| 2 | QI-130-050_Log_Samples_and_Batch_Number | QI-130-050_Log_Samples_and_Batch_Number | Inspection Owner | 5 | 2 |
...
#### BUSINESS ARCHITECTURE — 3.2.1 QI-130-040_Document_Results — QI-130-040_Document_Results

**Swim Lanes**: Quality Analyst · Quality Engineer (Extended Production Operations) · Quality Manager | **Tasks**: 5 | **Gateways**: 2
...
flowchart TD
    ...
    subgraph lane_0["Quality Analyst"]
        n1["fa:fa-user Enter the Inspected Values against the characteristic"]
        n5["Inspect Quantitative and Qualitative Characteristics"]
        n7["Landing Page - QI-130-020 Create Inspection Lot"]
    end
    subgraph lane_1["Quality Engineer (Extended Production Operations)"]
        n2["fa:fa-user Accept and Close the Characteristic (Status 5)"]
        n3["fa:fa-user Reject and Close the Characteristic (Status 5)"]
        n8{{"fa:fa-code-branch Is Results Recording Status Within or Outside Limits?"}}
        n9{{"fa:fa-code-branch exclusiveGateway"}}
    end
    subgraph lane_2["Quality Manager"]
        n4["fa:fa-user Perform Usage Decision"]
        n6["Transfer Materials from Quality Inspection to Stock"]
    end
    n7 --> n5
    n5 --> n1
    n8 -->|"Within Limits"| n2
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqlVm1v4jgQ_itWqoo9KZHySiAf9kQDOVVqtd2ju_thOZ2M44CviY1sp4Vl-e83JuElLP1ylw_APJl5ZubxZMjWIiKnVmLd3m4ZZzpB255e0or2EtSbY0V7NmqAr1gyPC-p6hmfQnA9ZT_2bl64Whs3g2W4YuXGoFO6EBR9ubfRCAJLGynMlaOoZEXP7q0kq7DcpKIU0njf0EHhFvts7a07IXMqTw6uG3skgtCScXqCgziMw8zEKUoEzzukRVQMCtLbmeJK8UaWWOp9-bWij3j9jeV6CXaBS0XBZ6mr8gHPaWl61LI2GKnl60EMpkweDoJNV5gwvgA8dAGSmL-coMjd7dDu9nbGj0nR83jGEVykxEqNaYGUBnjyqlHByjK5CdNRFrm20lK80OTGn8TjwLeJ6SSB1l3biOu8UbZY6mQuyrx1dd5MD4m_WttynfiuLTfweZGL8vyUKe37A39wzHQXe6mXHjIVRfG_MoGu8hmrlzbXJMj8bHzM5UX9KHV_5Tu0OQ7jkXepE5WvjNAz0izLgslJqkk_8tz3Se-yoO-mF6QLrOkb3pwIh2l4JMyiOPPidwmbfJdV1vMnKciBMJhEWXQkjO-8bOS_SxiOvHDQVgg8C4lXS1RiTv92v8-szzUumd6gEcflRumZ9VfjaS7ugUOBkwI7Rng04Ro-4WlF91ytKNE0R19xWVOF8AIzrvT-pplIDDclU5qRLmMEjG0wgtRcM401e6UI8xw1tTR22iFRXZYYWB4gAp4H9IQXFDno873jBa7j-i5KJQX9DzUywdGDODUGw3pNC-9MiwlfwA6AVj9M1hr8oU1QP68bsk8rKrH5pX7rVuV31RoRQld631haCkX32nTbQh-m0G6tUHRBFXSp_qT_GMH-E9Vguz1wmVXszGGZkCW6V8Cq6lKbbwK70GjZUnxjesk4EhJ9qrViOUUPrGJa_T6zdrsz6uF1aromZa3gEP9oHoNT1Dva-2faP2IOByq7PYRdOZ6oLISs0Bdlzn5MCVNwHN2QPoQ8Qz2qgIBHbGSCLYwKKSp0yHU2IVpA84K8_DomPEaO8xEmtzWjxmz3CB8Y8-fMajVrhJpZP2EcWg-_CRi2ZtA1h40ZtmbYmP3W9BpzcJGseyz7bMHZxjBxh03Zgf3rcHAdDq_D_eN_SweOr8ODwzLsoMMDatlWRWWFWW4lW2v_IgAvCzktMIymtbMtXGsx3XBiJfs_TKte5RA5Zhjmp2rA3b-707Ug" title="View full diagram">&#128065; View Diagram</a></div>
...
**Swim Lanes**: Inspection Owner | **Tasks**: 5 | **Gateways**: 2
...
flowchart TD
    ...
    classDef gateway fill:#FFF9C4,stroke:#F57F17,stroke-width:2px,color:#E65100
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["Inspection Owner"]
        n1["fa:fa-user Perform Usage Decision"]
        n2["fa:fa-user Post the Remaining Stock Quantity to Unrestricted/Blocked"]
        n3["fa:fa-user Perform Usage Decision"]
        n4["fa:fa-user Post Sum of Withdrawn Physical sample quantities to sample Consumption"]
        n5["fa:fa-user Post Remaining stock Quantity to Unrestricted/Blocked"]
        n6(["fa:fa-play Sample Info Received"])
        n7(["fa:fa-play Sample Info Received"])
        n8(["fa:fa-stop Sample Info Sent"])
        n9(["fa:fa-stop Stock Quantity Posted"])
        n10(["fa:fa-stop Sample Info Sent"])
        n11(["fa:fa-stop Stock Quantity Posted"])
        n12{{"fa:fa-code-branch Is Another Physical Sample Required for Inspection?"}}
        n13{{"fa:fa-code-branch Is Another Physical Sample Required?"}}
        n14[["fa:fa-folder-open Document Results"]]
        n15[["fa:fa-folder-open Document Results"]]
    end
    n6 --> n14
    n7 --> n15
    n14 --> n12
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqlVu1v4jYY_1esVBWbFLS8EpoPmygQqdJu647rnaZjmkzyBKwmds52ShnH_342SUgD6Yd2fED459_L8xjHzt6IWQJGaFxf7wklMkT7gdxADoMQDVZYwMBEFfAZc4JXGYiB5qSMygX570izveJZ0zQW4ZxkO40uYM0APdyZaKKEmYkEpmIogJN0YA4KTnLMd1OWMa7ZVzBOrfSYVk_dMp4AbwmWFdixr6QZodDCbuAFXqR1AmJGk45p6qfjNB4cdHEZ28YbzOWx_FLAB_z8hSRyo8YpzgQozkbm2e94BZnuUfJSY3HJn5rFIELnULVgiwLHhK4V7lkK4pg-tpBvHQ7ocH29pKdQ9Gm2pEh94gwLMYMUCang-ZNEKcmy8MqbTiLfMoXk7BHCK2cezFzHjHUnoWrdMvXiDrdA1hsZrliW1NThVvcQOsWzyZ9DxzL5Tn2fZQFN2qTpyBk741PSbWBP7WmTlKbp_0pS68o_YfFYZ83dyIlmpyzbH_lT69KvaXPmBRP7fJ2AP5EYXphGUeTO26Waj3zbet30NnJH1vTMdI0lbPGuNbyZeifDyA8iO3jVsMo7r7Jc3XMWN4bu3I_8k2Fwa0cT51VDb2J747pC5bPmuNigDFP41_q6NO6oKCCWhFH055YCXxr_VFT9obZipDhM8VCvPLoHnjKeoweB14BmEBOhhF2JcyZhQiL1gKOPkGN1AtA1WkgWP6K_SkwlkTskGXqgHFT5JJaQ_HKbqWlIuq7u2wvxegpZlDliKfpC5CbheEvR_WYnSIwzdXrkRQboW1UVAaHrqsEpo6LMC3kR4fdEtH2Kd_Q5-ulkWWRqBy2qCu5oypRzDOTpqPj5hSR4u2TcSlSRRUeyACrP6Dfn9G5juu2LCNt6W4ZtvyfE2e8bkb5nhit1UsYbdCfQhDK163j7B9f5H-FbSTgkSO0f1G7-35bG4fDS2X2384WV9_XUWarOO-BDVgBFMxaXuVoIJRRlJoXqrfPo-W-VqWO4-kFHaDj8VSfX46Ae-_XY9mrAaQBHA9-Xxh9saXxX4waveBe0v0EceeN6wql4Nw3Pr_3dBnDPhLZ1PlMnNwq3cmg6qAtuGmj8X57mutrmfujATj_s9sNeP-z3w6PTRduBg354XF-VHfCmD7StXtTuRZ3mwunCbj_sNbdJF_Yb2DCNHLg6xBIj3BvHdzP1_pZAitV2Mw6mgUvJFjsaG-HxHcYoi0TlzAhWV0tegYcfxdYpAw==" title="View full diagram">&#128065; View Diagram</a></div>
...
**Swim Lanes**: Inspection Owner | **Tasks**: 6 | **Gateways**: 4
...
flowchart TD
    ...
    classDef subProc fill:#F3E5F5,stroke:#7B1FA2,stroke-width:2px,color:#4A148C
    subgraph lane_0["Inspection Owner"]
        n1["fa:fa-user Enter the Inspected Values against the characteristics"]
        n2["fa:fa-user Reject and close the characteristic (Status 5)"]
        n3["fa:fa-user Accept and close the characteristic (Status 5)"]
        n4["fa:fa-user Perform Usage Decision"]
        n5["fa:fa-user Reopen and Initiate Result Recording Again"]
        n6["Inspect Quantitative and Qualitative Characteristics"]
        n7["Transfer Materials from Quality Inspection to Stock"]
        n8["Landing Page - QI-130-020 Create Inspection Lot"]
        n9{{"fa:fa-code-branch Is Results Recording Status Within Limits ?"}}
        n10{{"fa:fa-code-branch exclusiveGateway"}}
        n11{{"fa:fa-code-branch Are the results properly recorded ?"}}
    ...
    n12 --> n9
    n4 --> n7
    n9 -->|"Yes (Within Limits)"| n3
    n9 -->|"No (Outside Limits)"| n2
    n5 --> n12
    class n1 userTask
    class n2 userTask
    class n3 userTask
...
<div style="text-align:center; margin:4px 0 8px 0; font-size:11px;"><a href="https://mermaid.live/view#pako:eNqllm2P4jYQx7-KldWKPSmR8kggL1qxQKqV9u72yt6dqlJVxnHA3WAj21ngOL57xyEBwrGV2vKC3fl7_JsHO0N2FhEZtRLr9nbHONMJ2nX0gi5pJ0GdGVa0Y6OD8AVLhmcFVR3jkwuuJ-xb5eaFq41xM1qKl6zYGnVC54Kizw82GsDGwkYKc-UoKlnesTsryZZYboeiENJ439Be7uZVtHrpXsiMypOD68YeiWBrwTg9yUEcxmFq9ilKBM9a0DzKeznp7E1yhViTBZa6Sr9U9D3efGWZXoCd40JR8FnoZfGIZ7QwNWpZGo2U8rVpBlMmDoeGTVaYMD4HPXRBkpi_nKTI3e_R_vZ2yo9B0fNoyhF8SIGVGtEcKQ3y-FWjnBVFchMOB2nk2kpL8UKTG38cjwLfJqaSBEp3bdNcZ03ZfKGTmSiy2tVZmxoSf7Wx5SbxXVtu4fsiFuXZKdKw6_f83jHSfewNvWETKc_z_xUJ-iqfsXqpY42D1E9Hx1he1I2G7o-8psxRGA-8yz5R-coIPYOmaRqMT60adyPPfRt6nwZdd3gBnWNN13h7AvaH4RGYRnHqxW8CD_EusyxnT1KQBhiMozQ6AuN7Lx34bwLDgRf26gyBM5d4tUAF5vRP9_ep9cDVihLNBEcf15zKqfXHwdV8uAceOU5y7JjOozHX8A2PK6q30Qx9wUVJFcJzzLjS1aK5khgWJVOaEdVG-m3kr_Qv4CDMM6hWKHoFgO4mGutSoehdGxW0UQNC6Oo_osI26onKXMgl-qzwnKIRJUxBh9pbostCxIryKvoDDDoGVwA0VRYa_hAYNvDwooHpUhvTPR0C-lRirhlkyF5pRQKhaOzhP3U1BsozjAmVQyrvsfGCoYNyKZY1ZIvOjloLNNGCvLQhPYA8QliT6ZMp3EGfHhwvcB3Xd9FQUlPTGeVR6Dagv9s1PTFj35lBRmSBHlTdCXXWivogvjK9YIBiSwbLP0-t_f78_rnXiXRDilJBV345PGmX27zr2wbycClknc1KwpnJYguCSQtu8w8J-P82ARiGh394DznOT3DAtdk9mPUA4l5t-rXt13b96PPgwvbcWjgCKsL3qfUbhcvwHe7w5cIHUelRo9ch-rUdHsy4NvsnHLprHcu7ChNc-H0Q6O5jqRXLaMuvKShqF1jNMlN2M8Nbsn9dDq7L4XU5ui7Hxx_Dlty7Lveb6d1O270ue9dlv5Et21pSucQss5KdVb3owMtQRnMMF9Da2xYutZhsObGS6oXAKlcZ7BwxDHN6eRD3fwO-SPVg" title="View full diagram">&#128065; View Diagram</a></div>
...
|------------|-------------------|-------------|
| Quality Analyst | QI-130-040_Document_Results,  | |
| Quality Engineer (Extended Production Operations) | QI-130-040_Document_Results,  | |
...
The following data entities are derived from the system integration flows for QI-130. Tower architects should validate ownership and classification.
...
The Current-State architecture represents the **current / legacy** landscape for QI-130.
...
The Future-State architecture represents the **target** landscape for QI-130.
...
Integration patterns identified from the system flow analysis for QI-130:
...
Platform landscape inferred from integrated systems for QI-130:
...
Standard RAID items for QI-130 (Procure To Pay):

| # | Category | Description | Status | Owner | Priority |
|---|----------|-------------|--------|-------|----------|
| 1 | Risk | Data migration completeness — validate all legacy Perform Incoming Quality Assurance data maps to S/4 target structures | Open | Tower Architect | High |
...
---
*QI-130 — Architecture Document (TOGAF BDAT) · Procure To Pay · Generated: April 2026*
